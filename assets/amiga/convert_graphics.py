0x208, 0x29c, 0x13e, 0x1f0, 0x3c9, 0x337, 0xaf, 0x199, 0x90, 0x14a,
0x287, 0x1d2, 0x68, 0x216, 0x2d8, 0x311, 0x35f, 0x1ab, 0x2d2, 0x297, 0x45d, 0x5c,
0x62, 0x89, 0x162, 0x19f, 0x1ca, 0x355, 0x2a3, 0x9, 0x5ef, 0x38b, 0x1e8, 0x3a1,
0x253, 0x2b3, 0x2fb, 0x335, 0xad, 0x2d4, 0x36, 0x28f, 0x33f, 0x210, 0x1ee, 0x30f,
0x2a9, 0x148, 0x87, 0x1c0, 0x14f, 0x309, 0x60, 0xa2, 0x5f7, 0x31c, 0x5e7, 0x1,
0x7d, 0x2d6, 0x127, 0x81, 0x1a1, 0xb1, 0x463, 0x179, 0x2b1, 0x38d, 0x4f7, 0x263,
0x2ab, 0x2d0, 0x23b, 0x9a, 0x1b3, 0xb5, 0x5ed, 0x30b, 0xb7, 0x47, 0x518, 0x92,
0x171, 0x45b, 0x1cc, 0x74, 0x101, 0x5e3, 0x38f, 0x154, 0x2ca, 0x2af, 0x218,
0x27d, 0x318, 0x10, 0x482, 0x66, 0x453, 0x197, 0x507, 0x58, 0x19b, 0x30d,
0x49, 0x35d, 0x1d4, 0x303, 0x5f9, 0x25e, 0x503, 0x2a7, 0x134, 0x1c6, 0x2b8, 
0x5FD,0x27B,0x5fb, 0xa6}

# consistency, else it's hell to debug as grouped sprites cancel each other!
common = group_sprite_pairs & group_sprite_triplets
if common:
    raise Exception(f"Common sprite tiles between pairs & triplets: {common}")
for t in group_sprite_triplets:
    for i in range(t+1,t+2):
        if i in group_sprite_pairs:
            raise Exception(f"Pairs & triplets overlap at least on 0x{i:04x}: triplet 0x{t:04x}")
        if i in group_sprite_triplets:
            raise Exception(f"Triplets inter-overlap at least on 0x{i:04x}: triplet 0x{t:04x}")
##group_sprite_triplets = set()
for t in group_sprite_pairs:
    if t+1 in group_sprite_triplets:
            raise group_sprite_pairs(f"Pairs & triplets overlap at least on 0x{t+1:04x}: pair 0x{t:04x}")
    if t+1 in group_sprite_triplets:
            raise Exception(f"Pairs inter-overlap at least on 0x{t+1:04x}: pair 0x{t:04x}")
##group_sprite_triplets = set()
...
params = [
[{},[0xCA3,0xCCC]],  # 0 default
[{},[0xCA3,0xCCC]], #1 pier
[{},[0x0C0,0xCCC]], #2 fuji
[{0x80C:0xC0},[0xCA3,0x8F0]], #3 bamboo
[{0x80C:0xC0},[0xCA3,0x8F0]], #4 bridge
[{},[0xCA3,0xCCC]], #5 boat
...
[{},[0xCA3,0xCCC]],  #11
[{0xFC0:0xC0},[0xCA3,0x8F0]],  #12 moonlight
[{},[0,0xCCC]],  #13  ???? probably not used
...
for k,chardat in enumerate(sprite_array):
    ...
    for cidx,colors in enumerate(sprite_cluts):
        ...
        if k not in avoid_single_tile and (not used_sprite_cluts or (k in used_sprite_cluts and cidx in used_sprite_cluts[k])):
            ...
            if dump_sprites:
                scaled = ImageOps.scale(img,5,0)
                scaled.save(os.path.join(sprite_dump_dir,f"sprite_{k:04x}_{cidx}.png"))
        else:
            sprite_codes.append(None)
    if any(sprite_codes):
