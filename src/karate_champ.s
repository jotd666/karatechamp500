...
intro:
	...
	lea		bull(pc),a0
	move.w	#LEFT,bull_sprite_direction(a0)
...
draw_bull:
	...
	lea	bull(pc),a4
	lea	bull_0,a0
	cmp.w	bull_sprite_direction(a4),d2
	beq.b	.no_mirror
	move.w	d2,bull_sprite_direction(a4)	; note down
	move.w	d0,d2
	move.w	d1,d3
	move.w	#10,d0	; 64+16
	move.w	#120,d1	; 40*3
