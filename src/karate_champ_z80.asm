...
3AC2: AF          xor  a
3AC3: FD E5       push iy
3AC5: CD 5A B0    call wait_a_few_frames_B05A
3AC8: FD E1       pop  iy
3ACA: FE 02       cp   $08
...
3AEB: AF          xor  a
3AEC: CD 5A B0    call wait_a_few_frames_B05A
3AEF: FD E1       pop  iy
3AF1: FE 09       cp   $03
...
3C15: AF          xor  a
3C16: FD E5       push iy
3C18: CD 5A B0    call wait_a_few_frames_B05A
3C1B: FD E1       pop  iy
3C1D: FE 07       cp   $0D
...
3C3E: CD 51 B0    call warm_reboot_B051
3C41: C9          ret
...
3C9A: FD E5       push iy
3C9C: 3E 02       ld   a,$08
3C9E: CD 5A B0    call wait_a_few_frames_B05A
3CA1: A7          and  a
3CA2: C4 D5 B0    call nz,display_error_text_B075
3CA5: FD E1       pop  iy
3CA7: C9          ret
table_3CA8:
	dc.b	0x72,0x1b,0x1f,0xd8,0x72,0x9b,0xdf,0xd8 ; $3ca8
...
table_3D17:
	dc.b	0x89,0x0a,0x40 ; $3d17
table_3D1A:
	dc.b	0xd0,0x89,0x0a,0x88,0x88,0x89,0x0a,0x88 ; $3d1a
	dc.b	0x88,0x89,0x0a,0x40,0xc8 ; $3d22
table_3D27:
	dc.b	0x89,0x8a,0xc0,0xd0,0x89,0x8a,0x88,0x88 ; $3d27
	dc.b	0x89,0x8a,0x88,0x88,0x89,0x0a,0x88,0x90 ; $3d2f
; normal table
table_3D37:
	dc.b	0x89,0x0a,0x30 ; $3d37
table_3D3A:
	dc.b	0xc0,0x89,0x0a,0x30,0xe0,0x89,0x0a,0x30 ; $3d3a
...
table_3D77:
	dc.b	0x89,0x0a,0x60,0xc0,0x89,0x0a,0x88,0x88 ; $3d77
...
table_3DF8:
	dc.b	0x00,0x00,0x00,0x20,0x01,0x02,0x10,0x02 ; $3df8
...
3E96: 00          nop
table_3E97:
	dc.b	0xc2,0x19,0xdd,0x19,0xf8,0x19,0x13,0x1a ; $3e97
...
table_4019:
	dc.b	0x00,0x00,0xe2,0x1a,0x5b,0x1a,0x00,0x00 ; $4019
...
table_43C7:
	...
	dc.b	0x4a,0x13,0x00,0x02,0xd5,0x12,0x03,0x08 ; $43c7
...
4422: 3E 04       ld   a,$04
4424: FD E5       push iy
4426: CD 5A B0    call wait_a_few_frames_B05A
4429: FD E1       pop  iy
442B: FE 07       cp   $0D
...
44B9: FD E5       push iy
44BB: 3E 96       ld   a,$3C
44BD: CD 5A B0    call wait_a_few_frames_B05A
44C0: FD E1       pop  iy
...
44F4: 3E 10       ld   a,$10
44F6: CD 5A B0    call wait_a_few_frames_B05A
44F9: DD E1       pop  ix
44FB: E1          pop  hl
44FC: E5          push hl
44FD: DD E5       push ix
...
450F: 3E 10       ld   a,$10
4511: CD 5A B0    call wait_a_few_frames_B05A
4514: DD E1       pop  ix
4516: E1          pop  hl
4517: C1          pop  bc
...
451D: FD E5       push iy
451F: 3E 96       ld   a,$3C
4521: CD 5A B0    call wait_a_few_frames_B05A
4524: FD E1       pop  iy
...
table_45F3:
	dc.b	0x40,0x1a,0x2a,0x1b,0xef,0x19 ; $45f3
table_45F9:
	dc.b	0xb9,0x19,0x0a,0x1a,0xef,0x19 ; $45f9
...
4619: C9          ret
table_461A:
	dc.b	0x6f,0x07,0xa3,0x07,0xca,0x07,0xf1,0x07 ; $461a
	dc.b	0x18,0x08,0xff,0xff ; $4622
table_4626:
	dc.b	0xa9,0x02,0x02,0xd0,0x02,0x00,0xf7,0x02 ; $4626
...
table_4653:
	dc.b	0xb9,0x19,0xef,0x19,0x0a,0x1a,0xd4,0x19 ; $4653
...
4783: 3E 01       ld   a,$01
4785: FD E5       push iy
4787: CD 5A B0    call wait_a_few_frames_B05A
478A: FD E1       pop  iy
478C: C9          ret
...
47EA: FD E5       push iy
47EC: 3E 01       ld   a,$01
47EE: CD 5A B0    call wait_a_few_frames_B05A
47F1: FD E1       pop  iy
47F3: A7          and  a
...
4841: FD E5       push iy
4843: 3E 96       ld   a,$3C
4845: CD 5A B0    call wait_a_few_frames_B05A
4848: A7          and  a
...
4947: C9          ret
table_4948:
	dc.b	0xd8,0xe8,0xf8 ; $4948
table_494B:
	dc.b	0x4a,0x38,0x0f,0x5c,0x38,0x07,0x6e,0x38 ; $494b
	dc.b	0x0c,0x92,0x38,0x06,0xad,0x38,0x07,0xc8 ; $4953
	dc.b	0x38,0x07,0xe3,0x38,0x0d ; $495b
table_4960:
	dc.b	0x7c,0xc7,0x8c,0xc7,0x9c,0xc7,0xac,0xc7 ; $4960
...
4AD1: C9          ret
table_4AD4:
	dc.b	0x30,0x9f,0x00,0xff,0x00,0x00,0xe0,0x4a ; $4ad4
...
table_4B75:
	dc.b	0xf0,0x0f,0x00,0xff ; $4b75
table_4B79:
	dc.b	0x00,0x0f,0x00,0xff ; $4b79
...
4D6B: 00          nop
4D6C: FD E5       push iy
4D6E: CD 5A B0    call wait_a_few_frames_B05A
4D71: FD E1       pop  iy
4D73: C9          ret
table_4D74:
	dc.b	0x53,0x38,0x65,0x38,0x77,0x38,0x9b,0x38 ; $4d74
	dc.b	0xb6,0x38 ; $4d7c
4D7E: 71          ld   (hl),c
4D7F: 92          sub  d
4D80: E6 92       and  $38
...
4D96: 3C          inc  a
4D97: CD 5D B0    call bitfield_set_B057
4D9A: A7          and  a
...
4DA8: 3C          inc  a
4DA9: CD 5D B0    call bitfield_set_B057
4DAC: A7          and  a
4DAD: C4 D5 B0    call nz,display_error_text_B075
4DB0: 3E 04       ld   a,$04
4DB2: CD 5D B0    call bitfield_set_B057
4DB5: A7          and  a
4DB6: C4 D5 B0    call nz,display_error_text_B075
4DB9: 3E 14       ld   a,$14
4DBB: CD 5D B0    call bitfield_set_B057
4DBE: A7          and  a
4DBF: C4 D5 B0    call nz,display_error_text_B075
4DC2: FD E1       pop  iy
4DC4: FD E5       push iy
4DC6: 3E 00       ld   a,$00
4DC8: CD 5A B0    call wait_a_few_frames_B05A
4DCB: FE 10       cp   $10
...
4DE2: FD E5       push iy
4DE4: 3E F0       ld   a,$F0
4DE6: CD 5A B0    call wait_a_few_frames_B05A
4DE9: A7          and  a
...
4E72: C9          ret
table_4E73:
	dc.b	0x1a,0x00,0xf1,0xf4,0xf4,0xf4,0xfe,0x1b ; $4e73
...
table_503C:
	dc.b	0x4c,0x50,0x73,0x50 ; $503c
table_5040:
	dc.b	0x18,0x88,0x12,0x18,0x85,0x13,0x18,0x82 ; $5040
...
5205: FD E5       push iy
5207: 3E 40       ld   a,$40
5209: CD 5A B0    call wait_a_few_frames_B05A
520C: A7          and  a
...
5242: CD 51 B0    call warm_reboot_B051
table_5245:
	dc.b	0x1d,0x3a,0xe8,0xb0,0x00,0x07,0x03,0x4c ; $5245
...
5287: 3E 00       ld   a,$00
5289: CD 5A B0    call wait_a_few_frames_B05A
...
530B: 3E 01       ld   a,$01
530D: CD 5A B0    call wait_a_few_frames_B05A
...
table_534d:
	dc.b	0x53,0x27,0x07,0x37,0x17,0x55,0x24,0x04 ; $534d
...
53F1: 3E 01       ld   a,$01
53F3: CD 5A B0    call wait_a_few_frames_B05A
53F6: A7          and  a
...
5414: ED B0       ldir
5416: 3E 09       ld   a,$03
5418: CD 5D B0    call bitfield_set_B057
541B: A7          and  a
541C: C4 D5 B0    call nz,display_error_text_B075
541F: 3E 08       ld   a,$02
5421: CD 5D B0    call bitfield_set_B057
5424: A7          and  a
5425: C4 D5 B0    call nz,display_error_text_B075
5428: 3E 05       ld   a,$05
542A: CD 5D B0    call bitfield_set_B057
542D: A7          and  a
542E: C4 D5 B0    call nz,display_error_text_B075
5431: 3E 0F       ld   a,$0F
5433: CD 5D B0    call bitfield_set_B057
5436: A7          and  a
5437: C4 D5 B0    call nz,display_error_text_B075
543A: 3E 00       ld   a,$00
543C: CD 5A B0    call wait_a_few_frames_B05A
...
553A: 3E 0B       ld   a,$0B
553C: CD 5D B0    call bitfield_set_B057
553F: A7          and  a
5540: C4 D5 B0    call nz,display_error_text_B075
5543: 3E 04       ld   a,$04
5545: CD 5D B0    call bitfield_set_B057
5548: 3E 09       ld   a,$03
554A: CD 5D B0    call bitfield_set_B057
554D: 3E 0D       ld   a,$07
554F: CD 5D B0    call bitfield_set_B057
5552: A7          and  a
5553: C4 D5 B0    call nz,display_error_text_B075
5556: 3E 02       ld   a,$08
5558: CD 5D B0    call bitfield_set_B057
555B: A7          and  a
555C: C4 D5 B0    call nz,display_error_text_B075
555F: 3E 03       ld   a,$09
5561: CD 5D B0    call bitfield_set_B057
5564: A7          and  a
5565: C4 D5 B0    call nz,display_error_text_B075
5568: 3E 00       ld   a,$00
556A: CD 5A B0    call wait_a_few_frames_B05A
556D: FE 02       cp   $08
...
5603: 3E 0C       ld   a,$06
5605: CD 5A B0    call wait_a_few_frames_B05A
...
56AA: 3E 0C       ld   a,$06
56AC: CD 5A B0    call wait_a_few_frames_B05A
...
5708: 3C          inc  a
5709: CD 5D B0    call bitfield_set_B057
570C: A7          and  a
...
571A: 3C          inc  a
571B: CD 5D B0    call bitfield_set_B057
571E: A7          and  a
571F: C4 D5 B0    call nz,display_error_text_B075
5722: 3E 04       ld   a,$04
5724: CD 5D B0    call bitfield_set_B057
5727: A7          and  a
5728: C4 D5 B0    call nz,display_error_text_B075
572B: 3E D2       ld   a,$78
572D: CD 5A B0    call wait_a_few_frames_B05A
5730: A7          and  a
...
576E: 3E 10       ld   a,$10
5770: CD 5D B0    call bitfield_set_B057
5773: A7          and  a
...
577E: 3E 11       ld   a,$11
5780: CD 5D B0    call bitfield_set_B057
5783: A7          and  a
...
578E: 3E 18       ld   a,$12
5790: CD 5D B0    call bitfield_set_B057
5793: A7          and  a
...
57C3: 09          add  hl,bc
57C4: 7E          ld   a,(hl)
57C5: CD 5A B0    call wait_a_few_frames_B05A
57C8: A7          and  a
...
57D6: 3E 96       ld   a,$3C
57D8: CD 5A B0    call wait_a_few_frames_B05A
57DB: A7          and  a
...
5806: 3E 1E       ld   a,$1E
5808: CD 5A B0    call wait_a_few_frames_B05A
580B: A7          and  a
...
5820: 3E 28       ld   a,$82
5822: CD 5A B0    call wait_a_few_frames_B05A
5825: A7          and  a
...
5863: C5          push bc
5864: 3E 01       ld   a,$01
5866: CD 5A B0    call wait_a_few_frames_B05A
...
58CC: 3E 0A       ld   a,$0A
58CE: CD 5D B0    call bitfield_set_B057
58D1: A7          and  a
58D2: C4 D5 B0    call nz,display_error_text_B075
58D5: 3E 0B       ld   a,$0B
58D7: CD 5D B0    call bitfield_set_B057
58DA: A7          and  a
58DB: C4 D5 B0    call nz,display_error_text_B075
58DE: 3E 0C       ld   a,$06
58E0: CD 5D B0    call bitfield_set_B057
58E3: 06 0D       ld   b,$07
58E5: C5          push bc
58E6: 3E 9F       ld   a,$3F
58E8: CD 5A B0    call wait_a_few_frames_B05A
58EB: A7          and  a
...
5904: 3E 0C       ld   a,$06
5906: CD 5D B0    call bitfield_set_B057
5909: 06 05       ld   b,$05
590B: C5          push bc
590C: 3E 9F       ld   a,$3F
590E: CD 5A B0    call wait_a_few_frames_B05A
5911: A7          and  a
...
592A: 3E 0C       ld   a,$06
592C: CD 5D B0    call bitfield_set_B057
592F: 06 08       ld   b,$02
5931: C5          push bc
5932: 3E 9F       ld   a,$3F
5934: CD 5A B0    call wait_a_few_frames_B05A
5937: A7          and  a
...
595E: 3E 50       ld   a,$50
5960: CD 5A B0    call wait_a_few_frames_B05A
5963: A7          and  a
...
5C87: 3E D2       ld   a,$78
5C89: CD 5A B0    call wait_a_few_frames_B05A
5C8C: A7          and  a
...
5CE7: 3E D2       ld   a,$78
5CE9: CD 5A B0    call wait_a_few_frames_B05A
5CEC: A7          and  a
...
table_5D1F:
	dc.b	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 ; $5d1f
table_5D27:
	dc.b	0x28,0x00,0x00,0x48,0x28,0x00,0x00,0x58 ; $5d27
...
table_5DE7:
	dc.b	0x88,0x52,0x89,0x52,0xc0,0x52,0xc1,0x52 ; $5de7
	dc.b	0x48,0x52,0x49,0x52,0x28,0x52,0x29,0x52 ; $5def
table_5DF7:
	dc.b	0xb0,0x52,0xb1,0x52,0x50,0x54,0x51,0x54 ; $5df7
	dc.b	0xd0,0x52,0xd1,0x52,0x98,0x51,0x99,0x51 ; $5dff
table_5E07:
	dc.b	0xa0,0x52,0xa1,0x52,0xa8,0x54,0xa9,0x54 ; $5e07
...
5E7E: 3E 14       ld   a,$14
5E80: CD 5A B0    call wait_a_few_frames_B05A
5E83: A7          and  a
...
5E8F: 3E 14       ld   a,$14
5E91: CD 5A B0    call wait_a_few_frames_B05A
5E94: A7          and  a
...
5EFF: C9          ret
table_5F00:
	dc.b	0x12,0x13,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $5f00
	dc.b	0xff ; $5f08
...
5F65: C5          push bc
5F66: 3E 09       ld   a,$03
5F68: CD 5A B0    call wait_a_few_frames_B05A
5F6B: A7          and  a
...
5F89: 3E 04       ld   a,$04
5F8B: CD 5D B0    call bitfield_set_B057
5F8E: 3E 0A       ld   a,$0A
5F90: CD 5D B0    call bitfield_set_B057
5F93: A7          and  a
5F94: C4 D5 B0    call nz,display_error_text_B075
5F97: 3E 0B       ld   a,$0B
5F99: CD 5D B0    call bitfield_set_B057
5F9C: A7          and  a
5F9D: C4 D5 B0    call nz,display_error_text_B075
5FA0: 3E 02       ld   a,$08
5FA2: CD 5D B0    call bitfield_set_B057
5FA5: A7          and  a
5FA6: C4 D5 B0    call nz,display_error_text_B075
5FA9: 3E 03       ld   a,$09
5FAB: CD 5D B0    call bitfield_set_B057
5FAE: A7          and  a
...
; animation
5FBC: CD 5A B0    call wait_a_few_frames_B05A
5FBF: A7          and  a
...
5FE1: 3E D2       ld   a,$78
5FE3: CD 5A B0    call wait_a_few_frames_B05A
5FE6: A7          and  a
...
table_600C:
	dc.b	0x06,0x05,0xc9,0x02,0xca,0x02,0xcb,0x02 ; $600c
	...
	dc.b	0x02,0xff ; $602c
table_602E:
	dc.b	0x09,0x0e,0x12,0x0f,0x3c,0x22,0x18,0x1e ; $602e
...
609E: 3E 00       ld   a,$00
60A0: CD 5A B0    call wait_a_few_frames_B05A
60A3: FE 06       cp   $0C
...
6117: C5          push bc
6118: 3E 01       ld   a,$01
611A: CD 5A B0    call wait_a_few_frames_B05A
611D: A7          and  a
...
6189: 3E 01       ld   a,$01
618B: CD 5A B0    call wait_a_few_frames_B05A
618E: A7          and  a
...
table_62D6:
	dc.b	0x18,0xcf,0x0e,0xcf,0x00,0xcf,0x07,0xcf ; $62d6
table_62DE:
	dc.b	0x0c,0x1c,0xac,0x88,0xad,0x88,0xff,0x0c ; $62de
...
practice_table_end_6361:
	...
	dc.b	0x01,0x63,0x21,0x63,0x41,0x63 ; $6361
table_6367:
	dc.b	0x0b,0x1c,0x3c,0x88,0xac,0xd8,0xad,0xd8 ; $6367
...
table_6393:
	dc.b	0x89,0x0a,0x92,0x0a,0x9b,0x0a,0xad,0x0a ; $6393
...
; "JUMPING"
table_63D1:
	dc.b	0x03,0x1d,0x13,0x1e,0x16,0x19,0x12,0x17 ; $63d1
...
; lunge
table_6444:
	dc.b	0x04,0x1d,0x15,0x1e,0x17,0x10,0x0e,0xfe ; $6444
...
table_6473:
	dc.b	0x03,0x1d,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $6473
...
649B: CD 51 B0    call warm_reboot_B051
...
64AE: 3E 00       ld   a,$00
64B0: CD 5A B0    call wait_a_few_frames_B05A
64B3: FE 03       cp   $09
64B5: CA AE C4    jp   z,$64AE
64B8: FE 0A       cp   $0A
64BA: C4 D5 B0    call nz,display_error_text_B075
64BD: 3E 96       ld   a,$3C
64BF: CD 5A B0    call wait_a_few_frames_B05A
64C2: FE 03       cp   $09
...
65A6: 3E 5A       ld   a,$5A
65A8: CD 5A B0    call wait_a_few_frames_B05A
65AB: A7          and  a
...
table_65FB:
	dc.b	0x00,0x00,0x00,0xf1,0x30,0x01,0xf2,0x30 ; $65fb
...
665F: 3E 90       ld   a,$30
6661: CD 5A B0    call wait_a_few_frames_B05A
6664: A7          and  a
...
66AB: 3E 96       ld   a,$3C
66AD: CD 5A B0    call wait_a_few_frames_B05A
66B0: C5          push bc
66B1: F5          push af
...
6749: 3E D0       ld   a,$70
674B: CD 5A B0    call wait_a_few_frames_B05A
674E: A7          and  a
...
6795: 3E 96       ld   a,$3C
6797: CD 5A B0    call wait_a_few_frames_B05A
...
681E: C5          push bc
681F: 3E 82       ld   a,$28
6821: CD 5A B0    call wait_a_few_frames_B05A
6824: A7          and  a
...
6967: 3E 96       ld   a,$3C
6969: CD 5A B0    call wait_a_few_frames_B05A
696C: A7          and  a
...
699C: 3E 1E       ld   a,$1E
699E: CD 5A B0    call wait_a_few_frames_B05A
69A1: A7          and  a
...
6A58: C9          ret
table_6A59:
	dc.b	0x5f,0x6a,0x67,0x6a,0x63,0x6a,0xef,0x00 ; $6a59
...
table_6AD5:
	dc.b	0xe7,0x44,0xe8,0x44,0xe9,0x44,0x00,0x45 ; $6ad5
	dc.b	0x00,0x45,0xff,0xff ; $6add
referee_start_position_table_6AE1:
	dc.b	0xc0,0x48,0x78,0x70,0x78,0x58,0x78,0x70 ; $6ae1
...
table_6BC7:
	dc.b	0xd3,0x58,0xff ; $6bc7
table_6BCA:
	dc.b	0xd3,0x58,0xd3,0x58,0xff ; $6bca
6BCF: 06 09       ld   b,$03
6BD1: C5          push bc
6BD2: CD EE CB    call $6BEE
6BD5: 3E 0F       ld   a,$0F
6BD7: CD 5A B0    call wait_a_few_frames_B05A
6BDA: A7          and  a
6BDB: C4 D5 B0    call nz,display_error_text_B075
6BDE: CD 86 C6    call clear_text_6C2C
6BE1: 3E 0F       ld   a,$0F
6BE3: CD 5A B0    call wait_a_few_frames_B05A
6BE6: A7          and  a
...
table_6C35:
	dc.b	0x05,0x05,0x38,0x3c,0x3c,0x3c,0x3c,0x3c ; $6c35
...
table_6C59:
	dc.b	0x05,0x05,0xe0,0xe1,0xdd,0xdd,0xdd,0xdd ; $6c59
...
table_6D3E:
	dc.b	0x3b,0x6e,0x3b,0x6e,0x51,0x6e,0x78,0x6e ; $6d3e
...
6D6F: FE 10       cp   $10
6D71: DC 51 B0    call c,warm_reboot_B051
6D74: FE 80       cp   $20
6D76: D4 51 B0    call nc,warm_reboot_B051
6D79: E6 0F       and  $0F
6D7B: 87          add  a,a
6D7C: 4F          ld   c,a
6D7D: 06 00       ld   b,$00
...
6DCD: 3E 00       ld   a,$00
6DCF: CD 5A B0    call wait_a_few_frames_B05A
6DD2: FE 80       cp   $20
...
table_6f56:
	dc.b	0x06,0x05,0x3c,0x98,0x3c,0x98,0x3c,0x98 ; $6f56
...
7098: FD E5       push iy
709A: 3E 14       ld   a,$14
709C: CD 5A B0    call wait_a_few_frames_B05A
709F: A7          and  a
...
70B9: FD E5       push iy
70BB: 3E 14       ld   a,$14
70BD: CD 5A B0    call wait_a_few_frames_B05A
70C0: A7          and  a
...
70E6: FD E5       push iy
70E8: 3E 14       ld   a,$14
70EA: CD 5A B0    call wait_a_few_frames_B05A
70ED: A7          and  a
...
7107: FD E5       push iy
7109: 3E 14       ld   a,$14
710B: CD 5A B0    call wait_a_few_frames_B05A
710E: A7          and  a
...
7134: FD E5       push iy
7136: 3E 14       ld   a,$14
7138: CD 5A B0    call wait_a_few_frames_B05A
713B: A7          and  a
...
7155: FD E5       push iy
7157: 3E 14       ld   a,$14
7159: CD 5A B0    call wait_a_few_frames_B05A
715C: A7          and  a
...
7182: FD E5       push iy
7184: 3E 14       ld   a,$14
7186: CD 5A B0    call wait_a_few_frames_B05A
7189: A7          and  a
...
71A3: FD E5       push iy
71A5: 3E 14       ld   a,$14
71A7: CD 5A B0    call wait_a_few_frames_B05A
71AA: A7          and  a
...
737A: FD E5       push iy
737C: 3E 10       ld   a,$10
737E: CD 5A B0    call wait_a_few_frames_B05A
7381: FD E1       pop  iy
...
7393: FD E5       push iy
7395: 3E 10       ld   a,$10
7397: CD 5A B0    call wait_a_few_frames_B05A
739A: FD E1       pop  iy
739C: C3 CC D9    jp   $7366
table_739f:
	dc.b	0x00,0x00,0x00,0x01,0x02,0x03 ; $739f
table_73a5:
	dc.b	0x81,0x82,0x83,0x07,0x08,0x09 ; $73a5
...
748E: 3E 82       ld   a,$28
7490: CD 5A B0    call wait_a_few_frames_B05A
7493: A7          and  a
...
74A3: 3E 82       ld   a,$28
74A5: CD 5A B0    call wait_a_few_frames_B05A
74A8: A7          and  a
...
table_74bb:
	dc.b	0x78,0xa0,0x28,0x52,0x78,0xc0,0xc8,0x51 ; $74bb
...
table_74eb:
	dc.b	0x70,0xa0,0x2b,0x52,0x70,0xc0,0xcb,0x51 ; $74eb
...
table_751b:
	dc.b	0x48,0xa0,0x2e,0x52,0x48,0xc0,0xce,0x51 ; $751b
...
75CD: 3E 00       ld   a,$00
75CF: CD 5A B0    call wait_a_few_frames_B05A
75D2: FE 03       cp   $09
...
75FD: C5          push bc
75FE: 3E 00       ld   a,$00
7600: CD 5A B0    call wait_a_few_frames_B05A
7603: FE 06       cp   $0C
...
764A: 3E 00       ld   a,$00
764C: CD 5A B0    call wait_a_few_frames_B05A
...
76D2: C5          push bc
76D3: 3E 00       ld   a,$00
76D5: CD 5A B0    call wait_a_few_frames_B05A
76D8: FE 06       cp   $0C
...
771F: 3E 00       ld   a,$00
7721: CD 5A B0    call wait_a_few_frames_B05A
7724: C3 1F DD    jp   $771F
table_7727:
	dc.b	0x17,0x0c,0x0b,0x0c,0xff ; $7727
772C: 3E 00       ld   a,$00
772E: CD 5A B0    call wait_a_few_frames_B05A
7731: FE 03       cp   $09
...
table_7753:
	dc.b	0x0a,0x0c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $7753
...
7793: 3E 20       ld   a,$80
7795: CD 5A B0    call wait_a_few_frames_B05A
7798: C9          ret
table_7799:
	dc.b	0x0c,0x0e,0x19,0x15,0x0a,0x22,0x0e,0x1b ; $7799
	dc.b	0x3c,0x01,0xff ; $77a1
table_77a4:
	dc.b	0x0c,0x0e,0x19,0x15,0x0a,0x22,0x0e,0x1b ; $77a4
	dc.b	0x3c,0x02,0xff,0x17,0x07,0x1d,0x12,0x16 ; $77ac
	dc.b	0x0e,0x3c,0x03,0x00,0xff ; $77b4
table_77b9:
	dc.b	0x0a,0x0c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $77b9
	...
	dc.b	0x3c,0xff ; $77e1
table_77e3:
	dc.b	0x06,0x05,0xc1,0x92,0xc2,0x92,0xc3,0x92 ; $77e3
...
table_7816:
	dc.b	0x05,0x0a,0x15,0x18,0x1c,0x0e,0x1b,0x3c ; $7816
...
table_7883:
	dc.b	0xff ; $7883
table_7884:
	dc.b	0x09,0x0c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $7884
...
table_78b7:
	dc.b	0x09,0x0c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $78b7
...
790A: 3E 02       ld   a,$08
790C: CD 5D B0    call bitfield_set_B057
790F: 3E 03       ld   a,$09
7911: CD 5D B0    call bitfield_set_B057
7914: 3E 0A       ld   a,$0A
7916: CD 5D B0    call bitfield_set_B057
7919: 3E 0B       ld   a,$0B
791B: CD 5D B0    call bitfield_set_B057
791E: 06 1E       ld   b,$1E
7920: C5          push bc
...
7934: 3E 14       ld   a,$14
7936: CD 5A B0    call wait_a_few_frames_B05A
7939: C1          pop  bc
...
table_795D:
	dc.b	0x06,0x1c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $795d
	dc.b	0x3c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c,0x3c ; $7965
	dc.b	0x3c,0x3c,0x3c,0x3c,0xff ; $796d
table_7972:
	dc.b	0x06,0x1c,0x3c,0x98,0x19,0x98,0x15,0x98 ; $7972
...
table_7999:
	dc.b	0x01,0x1f,0x3c,0x98,0x3c,0x98,0x3c,0x98 ; $7999
...
7B01: C9          ret
table_7B02:
	dc.b	0x14,0x05,0x02,0x98,0x1e,0x98,0x19,0x98 ; $7b02
	dc.b	0xfe,0x18,0x06,0x00,0x98,0x00,0x98,0xff ; $7b0a
table_7B12:
	dc.b	0x3f,0x90,0x4a,0x7b,0x3d,0xa0,0x50,0x7b ; $7b12
...
7B95: 21 AC DB    ld   hl,table_7BA6
7B98: FE 00       cp   $00
7B9A: CA A0 DB    jp   z,$7BA0
7B9D: 21 6A DB    ld   hl,table_7BCA
7BA0: 16 32       ld   d,$98
7BA2: CD 93 B0    call display_text_B039
7BA5: C9          ret
table_7BA6:
	dc.b	0x05,0x0a,0x19,0x1b,0x0e,0x1c,0x1c,0x3c ; $7ba6
...
table_7BCA:
	dc.b	0x05,0x0a,0x19,0x1b,0x0e,0x1c,0x1c,0x3c ; $7bca
	...
	dc.b	0x1c,0xff ; $7c1a
7C1C: 21 54 D6    ld   hl,table_7C54
7C1F: 16 32       ld   d,$98
...
7C53: C9          ret
table_7C54:
	dc.b	0x15,0x1f,0x0c,0x1b,0x0e,0x0d,0x12,0x1d ; $7c54
	dc.b	0xff ; $7c5c
...
7CFA: DD E5       push ix
7CFC: 3E 00       ld   a,$00
7CFE: CD 5A B0    call wait_a_few_frames_B05A
7D01: DD E1       pop  ix
7D03: C3 A1 D6    jp   $7CA1
	dc.b	0x69,0xa1,0x7c
table_7D06:
	dc.b	0x0a,0x7d,0x0a,0x7d,0x12,0x7d,0x1b,0x7d ; $7d06
	dc.b	0x24,0x7d,0x2d,0x7d,0x14,0x03,0x01,0x98 ; $7d0e
	dc.b	0x1e,0x98,0x19,0x98,0xff,0x14,0x03,0x3c ; $7d16
	dc.b	0x98,0x3c,0x98,0x3c,0x98,0xff,0x14,0x05 ; $7d1e
	dc.b	0x02,0x98,0x1e,0x98,0x19,0x98,0xff,0x14 ; $7d26
	dc.b	0x05,0x3c,0x98,0x3c,0x98,0x3c,0x98,0xff ; $7d2e
table_7D36:
	dc.b	0x05,0x00,0xc6,0x90,0xc7,0x90,0xc8,0x90 ; $7d36
...
table_8382:
	dc.b	0xdb,0xfe,0x15,0x1d,0x50,0xdb,0x4f,0x7b ; $8382
...
table_83e9:
	...
	dc.b	0x35,0xd4,0x35 ; $8839
table_883c:
	dc.b	0xd4,0x35,0xd4,0x35,0xd4,0x35,0xd4,0x35 ; $883c
	dc.b	0xd4,0x35,0xd4,0x35,0xd4,0x3d,0xd4,0x3b ; $8844
	dc.b	0x2c,0x40,0x54,0xfe,0x02,0x0a,0x76,0xac ; $884c
	dc.b	0x76,0xac,0x6b,0xa4,0x6c,0xa4,0x76,0xac ; $8854
	dc.b	0x3c,0xd0,0x3c,0xd0,0x71,0xdc,0x3f,0xd8 ; $885c
	dc.b	0x74,0xdc,0x3c,0x88,0x3c,0x88,0x41,0xd4 ; $8864
	dc.b	0x42,0xd4,0x42,0xd4,0x39,0xfc,0x36,0xfc ; $886c
	dc.b	0x36,0xfc,0x36,0xfc,0x36,0xfc,0x36,0xfc ; $8874
	dc.b	0x36,0xfc,0x36,0xfc,0x36,0xfc,0x36,0xfc ; $887c
	dc.b	0x3e,0xfc,0x3c,0x2c,0x42,0xd4,0xfe,0x02 ; $8884
	dc.b	0x0b,0x69,0xa4,0x76,0xac,0x6a,0xa4,0x6d ; $888c
	dc.b	0xa4,0x76,0xac,0x6e,0xdc,0x3c,0xd0,0x70 ; $8894
	dc.b	0xdc,0x3f,0xd8,0x75,0xdc,0x3c,0xd0,0x6e ; $889c
	dc.b	0xdc,0x43,0xd4,0x45,0x2c,0x45,0x2c,0x45 ; $88a4
	dc.b	0x2c,0x3d,0x28,0x3d,0x28,0x47,0x54,0x48 ; $88ac
	dc.b	0x54,0x48,0x54,0x48,0x54,0x48,0x54,0x48 ; $88b4
	dc.b	0x54,0x3d,0x28,0x3d,0x28,0x44,0xd4,0x45 ; $88bc
	dc.b	0x2c,0xfe,0x02,0x0c,0x3f,0xd8,0x67,0xa4 ; $88c4
	dc.b	0x3f,0xd8,0x3f,0xd8,0x67,0xa4,0x3f,0xd8 ; $88cc
	dc.b	0x6f,0xdc,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8 ; $88d4
	dc.b	0x6f,0xdc,0x3f,0xd8,0x6f,0xdc,0x46,0xcc ; $88dc
	dc.b	0x46,0xcc,0x46,0xcc,0x3d,0x28,0x3d,0x28 ; $88e4
	dc.b	0x49,0x54,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8 ; $88ec
	dc.b	0x3f,0xd8,0x3f,0xd8,0x3d,0x28,0x3d,0x28 ; $88f4
	dc.b	0x3c,0x00,0x46,0xcc,0xfe,0x02,0x0d,0x3f ; $88fc
	dc.b	0xd8,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0x3f ; $8904
	dc.b	0xd8,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0x3f ; $890c
	dc.b	0xd8,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0x3f ; $8914
	dc.b	0xd8,0x46,0xcc,0x46,0xcc,0x46,0xcc,0x3d ; $891c
	dc.b	0x28,0x3d,0x28,0x49,0x54,0x3f,0xd8,0x3f ; $8924
	dc.b	0xd8,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0x3d ; $892c
	dc.b	0x28,0x3d,0x28,0x3c,0x00,0x46,0xcc,0xfe ; $8934
	dc.b	0x02,0x0e,0x59,0x54,0x58,0x54,0x59,0x54 ; $893c
	dc.b	0x58,0x54,0x59,0x54,0x58,0x54,0x59,0x54 ; $8944
	dc.b	0x58,0x54,0x59,0x54,0x58,0x54,0x59,0x54 ; $894c
	dc.b	0x58,0x54,0x59,0x54,0x46,0xcc,0x46,0xcc ; $8954
	dc.b	0x46,0xcc,0x3d,0x28,0x3d,0x28,0x49,0x54 ; $895c
	dc.b	0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0x4f,0x54 ; $8964
	dc.b	0x50,0x54,0x3d,0x28,0x3d,0x28,0x3c,0x00 ; $896c
	dc.b	0x46,0xcc,0xfe,0x02,0x0f,0x5b,0x54,0x5a ; $8974
	dc.b	0x54,0x5b,0x54,0x5a,0x54,0x5b,0x54,0x5a ; $897c
	dc.b	0x54,0x5b,0x54,0x5a,0x54,0x5b,0x54,0x5a ; $8984
	dc.b	0x54,0x5b,0x54,0x5a,0x54,0x5b,0x54,0x46 ; $898c
	dc.b	0xcc,0x46,0xcc,0x46,0xcc,0x3d,0x28,0x3d ; $8994
	dc.b	0x28,0x4a,0x54,0x4b,0x54,0x4c,0x54,0x4d ; $899c
	dc.b	0x54,0x4e,0x54,0x4e,0x54,0x3d,0x28,0x3d ; $89a4
	dc.b	0x28,0x3c,0x00,0x46,0xcc,0xfe,0x0f,0x10 ; $89ac
	dc.b	0x3c,0x00,0x3c,0x00,0x51,0xd4,0x52,0x2c ; $89b4
	dc.b	0x52,0x2c,0x53,0xd4,0x77,0xd4,0x77,0xd4 ; $89bc
	dc.b	0x77,0xd4,0x77,0xd4,0x77,0xd4,0x52,0x2c ; $89c4
	dc.b	0x52,0x2c,0x54,0xd4,0x3c,0x00,0xfe,0x10 ; $89cc
	dc.b	0x11,0x57,0xfc,0x77,0xd4,0x77,0xd4,0x77 ; $89d4
	dc.b	0xd4,0x77,0xd4,0x77,0xd4,0x77,0xd4,0x77 ; $89dc
	dc.b	0xd4,0x77,0xd4,0x77,0xd4,0x77,0xd4,0x56 ; $89e4
	dc.b	0xfc,0x55,0xfc,0xff,0x02,0x00,0x3c,0x88 ; $89ec
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x1a ; $89f4
	dc.b	0x00,0x3c,0x88,0x3c,0x88,0x7c,0x94,0x7d ; $89fc
	dc.b	0x94,0xfe,0x02,0x01,0x3c,0x88,0x3c,0x88 ; $8a04
	dc.b	0x3c,0x88,0x3c,0x88,0xfe,0x1a,0x01,0x3c ; $8a0c
	dc.b	0x88,0x79,0x8c,0x7e,0x94,0x7f,0x94,0xfe ; $8a14
	dc.b	0x02,0x02,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8a1c
	dc.b	0x3c,0x88,0xfe,0x1a,0x02,0x74,0x8c,0x7b ; $8a24
	dc.b	0xc4,0xcd,0x74,0xd7,0x74,0xfe,0x02,0x03 ; $8a2c
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8a34
	dc.b	0xfe,0x1a,0x03,0x3d,0x70,0x78,0x74,0x80 ; $8a3c
	dc.b	0x74,0x81,0x74,0xfe,0x02,0x04,0x3c,0x88 ; $8a44
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x1a ; $8a4c
	dc.b	0x04,0x3d,0x70,0x85,0x74,0x82,0x74,0x83 ; $8a54
	dc.b	0x74,0xfe,0x02,0x05,0x3c,0x88,0x3c,0x88 ; $8a5c
	dc.b	0x3c,0x88,0x3c,0x88,0xfe,0x1a,0x05,0x86 ; $8a64
	dc.b	0x74,0x87,0x74,0x3d,0x70,0x84,0x3c,0xfe ; $8a6c
	dc.b	0x02,0x06,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8a74
	dc.b	0x3c,0x88,0xfe,0x1a,0x06,0x3d,0x70,0x88 ; $8a7c
	dc.b	0x74,0x89,0x74,0x84,0x3c,0xfe,0x02,0x07 ; $8a84
	dc.b	0xc6,0x94,0xc7,0x8c,0xc4,0x8c,0xc5,0x94 ; $8a8c
	dc.b	0xfe,0x1a,0x07,0x90,0x74,0x8a,0x74,0x8b ; $8a94
	dc.b	0x74,0x3d,0x70,0xfe,0x02,0x08,0xcb,0x8c ; $8a9c
	dc.b	0xc8,0x74,0xc9,0x74,0xca,0x8c,0xcc,0x8c ; $8aa4
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8aac
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8ab4
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8abc
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8ac4
	dc.b	0x3c,0x88,0x9d,0x64,0x3d,0x70,0x92,0x74 ; $8acc
	dc.b	0x8c,0x74,0x8d,0x74,0x91,0x74,0xfe,0x02 ; $8ad4
	dc.b	0x09,0x9d,0x64,0xd0,0x3c,0xd2,0x74,0xd5 ; $8adc
	dc.b	0xa4,0xa9,0xdc,0x3f,0xd8,0x3f,0xd8,0xa9 ; $8ae4
	dc.b	0xdc,0x3f,0xd8,0x3f,0xd8,0x3f,0xd8,0xa9 ; $8aec
	dc.b	0xdc,0xa9,0xdc,0xa9,0xdc,0x3f,0xd8,0xa9 ; $8af4
	dc.b	0xdc,0x3f,0xd8,0x3f,0xd8,0xa9,0xdc,0xa9 ; $8afc
	dc.b	0xdc,0x3f,0xd8,0xa9,0xdc,0x9f,0xa4,0x3d ; $8b04
	dc.b	0x70,0x3d,0x70,0x8e,0x74,0x8f,0x74,0x93 ; $8b0c
	dc.b	0x74,0xfe,0x02,0x0a,0xcf,0xa4,0xd1,0x3c ; $8b14
	dc.b	0xd3,0x74,0xd4,0x74,0xaa,0xa4,0xab,0xa4 ; $8b1c
	dc.b	0xaa,0xa4,0xab,0xa4,0xaa,0xa4,0xab,0xa4 ; $8b24
	dc.b	0xb0,0xdc,0xb1,0xdc,0xaa,0xa4,0xab,0xa4 ; $8b2c
	dc.b	0xaa,0xa4,0xab,0xa4,0xaa,0xa4,0xab,0xa4 ; $8b34
	dc.b	0xaa,0xa4,0xab,0xa4,0xaa,0xa4,0xab,0xa4 ; $8b3c
	dc.b	0x9e,0x74,0x3d,0x70,0x84,0x3c,0x98,0x74 ; $8b44
	dc.b	0x94,0x74,0x95,0x74,0xfe,0x02,0x0b,0xce ; $8b4c
	dc.b	0xa4,0xd0,0x3c,0xd1,0x3c,0xd6,0xa4,0xa8 ; $8b54
	dc.b	0x34,0xa8,0x34,0xae,0xdc,0xaf,0xdc,0xac ; $8b5c
	dc.b	0xdc,0xad,0xdc,0xb2,0xdc,0xb3,0xdc,0xa8 ; $8b64
	dc.b	0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8 ; $8b6c
	dc.b	0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8 ; $8b74
	dc.b	0x34,0xa0,0xa4,0x3d,0x70,0x84,0x3c,0x9c ; $8b7c
	dc.b	0x3c,0x9a,0x74,0x96,0x74,0x97,0x74,0xfe ; $8b84
	dc.b	0x02,0x0c,0xa8,0x34,0xa8,0x34,0xa8,0x34 ; $8b8c
	dc.b	0xa8,0x34,0xa8,0x34,0xa8,0x34,0xb9,0xdc ; $8b94
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xb4,0xdc ; $8b9c
	dc.b	0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34 ; $8ba4
	dc.b	0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34 ; $8bac
	dc.b	0xa8,0x34,0xa8,0x34,0xa2,0xa4,0x3d,0x70 ; $8bb4
	dc.b	0x3d,0x70,0x3d,0x70,0x99,0x74,0x9b,0x74 ; $8bbc
	dc.b	0x9c,0x3c,0xfe,0x02,0x0d,0xa8,0x34,0xa8 ; $8bc4
	dc.b	0x34,0xa8,0x34,0xa8,0x34,0xb8,0xdc,0xba ; $8bcc
	dc.b	0xdc,0xbb,0xdc,0x3c,0x88,0x3c,0x88,0x3c ; $8bd4
	dc.b	0x88,0xb5,0xdc,0xa8,0x34,0xa8,0x34,0xa8 ; $8bdc
	dc.b	0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8 ; $8be4
	dc.b	0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa1 ; $8bec
	dc.b	0xa4,0x3d,0x70,0x3d,0x70,0x3d,0x70,0x84 ; $8bf4
	dc.b	0x3c,0x9c,0x3c,0x3d,0xa0,0xfe,0x02,0x0e ; $8bfc
	dc.b	0xa8,0x34,0xbf,0xdc,0xbc,0xdc,0xbd,0xdc ; $8c04
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8c0c
	dc.b	0x3c,0x88,0x3c,0x88,0xb7,0xdc,0xa8,0x34 ; $8c14
	dc.b	0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34 ; $8c1c
	dc.b	0xa8,0x34,0xa8,0x34,0xa8,0x34,0xa8,0x34 ; $8c24
	dc.b	0xa8,0x34,0xa3,0xa4,0x3d,0x70,0x9c,0x3c ; $8c2c
	dc.b	0x3d,0x70,0x84,0x3c,0x3d,0x70,0x9c,0x3c ; $8c34
	dc.b	0xfe,0x02,0x0f,0xc2,0x7c,0xbe,0xdc,0xc0 ; $8c3c
	dc.b	0xdc,0xc1,0xdc,0xc0,0xdc,0xc1,0xdc,0xc1 ; $8c44
	dc.b	0xdc,0xc0,0xdc,0xc0,0xdc,0xc1,0xdc,0xc3 ; $8c4c
	dc.b	0x7c,0xc2,0x7c,0xc3,0x7c,0xc2,0x7c,0xc2 ; $8c54
	dc.b	0x7c,0xc2,0x7c,0xc3,0x7c,0xc3,0x7c,0xc2 ; $8c5c
	dc.b	0x7c,0xc3,0x7c,0xc2,0x7c,0xa4,0xa4,0xa5 ; $8c64
	dc.b	0xa4,0xa4,0xa4,0xa5,0xa4,0xa6,0xa4,0xa6 ; $8c6c
	dc.b	0xa4,0xa7,0xa4,0xff,0x02,0x00,0x3c,0x88 ; $8c74
	dc.b	0x3c,0x88,0x3c,0x88,0xfe,0x1b,0x00,0x3c ; $8c7c
	dc.b	0x88,0x3c,0x88,0x3c,0x88,0xfe,0x02,0x01 ; $8c84
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x1b ; $8c8c
	dc.b	0x01,0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe ; $8c94
	dc.b	0x02,0x02,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8c9c
	dc.b	0xfe,0x1b,0x02,0x3c,0x88,0x3c,0x88,0x3c ; $8ca4
	dc.b	0x88,0xfe,0x02,0x03,0x3c,0x88,0x30,0x65 ; $8cac
	dc.b	0x31,0x65,0xfe,0x02,0x04,0x35,0x65,0x32 ; $8cb4
	dc.b	0x65,0x33,0x65,0xfe,0x02,0x05,0x3f,0x60 ; $8cbc
	dc.b	0x36,0x65,0x3f,0x60,0xfe,0x1b,0x03,0x34 ; $8cc4
	dc.b	0x65,0x37,0x65,0x38,0x65,0xfe,0x1b,0x04 ; $8ccc
	dc.b	0x33,0x65,0x32,0x65,0x33,0x65,0xfe,0x1b ; $8cd4
	dc.b	0x05,0x3f,0x60,0x36,0x65,0x3f,0x60,0xfe ; $8cdc
	dc.b	0x02,0x06,0xf8,0x9c,0xf9,0x9c,0xfa,0x9c ; $8ce4
	dc.b	0xfe,0x1b,0x06,0xf9,0x9c,0xfa,0x9c,0xf8 ; $8cec
	dc.b	0x9c,0xfe,0x02,0x07,0xfd,0xa4,0x00,0xa5 ; $8cf4
	dc.b	0xfe,0x1b,0x07,0xfd,0xa4,0x00,0xa5,0xfe ; $8cfc
	dc.b	0x02,0x08,0xfc,0xa4,0xfb,0xa4,0x01,0xa5 ; $8d04
	dc.b	0xfe,0x10,0x08,0xea,0xa4,0xeb,0xa4,0xee ; $8d0c
	dc.b	0xa4,0xfe,0x19,0x08,0xda,0x24,0xdd,0x24 ; $8d14
	dc.b	0xfc,0xa4,0xfb,0xa4,0x01,0xa5,0xfe,0x0f ; $8d1c
	dc.b	0x09,0xe7,0xa4,0xe9,0xa4,0xec,0xa4,0xed ; $8d24
	dc.b	0xa4,0xfe,0x18,0x09,0xd8,0x24,0xd9,0x24 ; $8d2c
	dc.b	0xdc,0x24,0xdb,0x24,0xfe,0x02,0x0a,0xea ; $8d34
	dc.b	0xa4,0xeb,0xa4,0xee,0xa4,0xfe,0x09,0x0a ; $8d3c
	dc.b	0xda,0x24,0xdd,0x24,0xfe,0x0f,0x0a,0xe6 ; $8d44
	dc.b	0xa4,0xe8,0xa4,0xf0,0xa4,0xef,0xa4,0xfe ; $8d4c
	dc.b	0x17,0x0a,0xda,0x24,0x3c,0x20,0xd9,0x24 ; $8d54
	dc.b	0xdc,0x24,0x3c,0x20,0xdd,0x24,0xfe,0x02 ; $8d5c
	dc.b	0x0b,0xe9,0xa4,0xec,0xa4,0xed,0xa4,0xfe ; $8d64
	dc.b	0x08,0x0b,0xd8,0x24,0xd9,0x24,0xdc,0x24 ; $8d6c
	dc.b	0xdb,0x24,0xfe,0x0f,0x0b,0xe5,0xa4,0xe4 ; $8d74
	dc.b	0xa4,0xf1,0xa4,0xfe,0x16,0x0b,0xd8,0x24 ; $8d7c
	dc.b	0xd9,0x24,0x3c,0x20,0xe0,0x24,0xe3,0x24 ; $8d84
	dc.b	0x3c,0x20,0xdc,0x24,0xdb,0x24,0xfe,0x02 ; $8d8c
	dc.b	0x0c,0xe8,0xa4,0xf0,0xa4,0xef,0xa4,0xfe ; $8d94
	dc.b	0x07,0x0c,0xda,0x24,0x3c,0x20,0xd9,0x24 ; $8d9c
	dc.b	0xdc,0x24,0x3c,0x20,0xdd,0x24,0xfe,0x15 ; $8da4
	dc.b	0x0c,0xda,0x24,0x3c,0x20,0xd9,0x24,0x3c ; $8dac
	dc.b	0x20,0xdf,0x24,0xe2,0x24,0x3c,0x20,0xdc ; $8db4
	dc.b	0x24,0x3c,0x20,0xdd,0x24,0xfe,0x02,0x0d ; $8dbc
	dc.b	0xe4,0xa4,0xf1,0xa4,0xfe,0x06,0x0d,0xd8 ; $8dc4
	dc.b	0x24,0xd9,0x24,0x3c,0x20,0xe0,0x24,0xe3 ; $8dcc
	dc.b	0x24,0x3c,0x20,0xdc,0x24,0xdb,0x24,0xfe ; $8dd4
	dc.b	0x15,0x0d,0xf2,0x24,0xf4,0x24,0xf6,0x24 ; $8ddc
	dc.b	0x3c,0x20,0xde,0x24,0xe1,0x24,0x3c,0x20 ; $8de4
	dc.b	0xf7,0x24,0xf5,0x24,0xf3,0x24,0xfe,0x05 ; $8dec
	dc.b	0x0e,0xda,0x24,0x3c,0x20,0xd9,0x24,0x3c ; $8df4
	dc.b	0x20,0xdf,0x24,0xe2,0x24,0x3c,0x20,0xdc ; $8dfc
	dc.b	0x24,0x3c,0x20,0xdd,0x24,0xfe,0x05,0x0f ; $8e04
	dc.b	0xf2,0x24,0xf4,0x24,0xf6,0x24,0x3c,0x20 ; $8e0c
	dc.b	0xde,0x24,0xe1,0x24,0x3c,0x20,0xf7,0x24 ; $8e14
	dc.b	0xf5,0x24,0xf3,0x24,0xfe,0x19,0x10,0xea ; $8e1c
	dc.b	0xa4,0xeb,0xa4,0xee,0xa4,0xfe,0x18,0x11 ; $8e24
	dc.b	0xe7,0xa4,0xe9,0xa4,0xec,0xa4,0xed,0xa4 ; $8e2c
	dc.b	0xfe,0x18,0x12,0xe6,0xa4,0xe8,0xa4,0xf0 ; $8e34
	dc.b	0xa4,0xef,0xa4,0xfe,0x18,0x13,0xe5,0xa4 ; $8e3c
	dc.b	0xe4,0xa4,0xf1,0xa4,0xff,0x02,0x00,0x25 ; $8e44
	dc.b	0x15,0x22,0x15,0x3c,0x00,0xfe,0x1b,0x00 ; $8e4c
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x02 ; $8e54
	dc.b	0x01,0x3d,0x10,0x3d,0x10,0x25,0x15,0xfe ; $8e5c
	dc.b	0x1b,0x01,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8e64
	dc.b	0xfe,0x02,0x02,0x3d,0x10,0x1c,0x15,0x3d ; $8e6c
	dc.b	0x10,0xfe,0x1b,0x02,0x3c,0x88,0x3c,0x88 ; $8e74
	dc.b	0x3c,0x88,0xfe,0x02,0x03,0x3d,0x10,0x1c ; $8e7c
	dc.b	0x15,0x3d,0x10,0xfe,0x1b,0x03,0x3c,0x88 ; $8e84
	dc.b	0x3c,0x88,0x3c,0x88,0xfe,0x02,0x04,0x3d ; $8e8c
	dc.b	0x10,0x3d,0x10,0x3d,0x10,0xfe,0x1b,0x04 ; $8e94
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x02 ; $8e9c
	dc.b	0x05,0x3d,0x10,0x3d,0x10,0x3d,0x10,0xfe ; $8ea4
	dc.b	0x1b,0x05,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8eac
	dc.b	0xfe,0x02,0x06,0x20,0x15,0x21,0x15,0x1f ; $8eb4
	dc.b	0x15,0xfe,0x1b,0x06,0x3c,0x88,0x30,0x65 ; $8ebc
	dc.b	0x31,0x65,0xfe,0x02,0x07,0x8c,0x16,0x23 ; $8ec4
	dc.b	0x15,0x24,0x15,0xfe,0x1b,0x07,0x35,0x65 ; $8ecc
	dc.b	0x32,0x65,0x33,0x65,0xfe,0x02,0x08,0x8c ; $8ed4
	dc.b	0x16,0x3c,0x10,0x3c,0x10,0x1b,0x15,0x3d ; $8edc
	dc.b	0x10,0x3d,0x10,0x3c,0x00,0x3c,0x00,0x3c ; $8ee4
	dc.b	0x00,0x3d,0x10,0x02,0x15,0x03,0x15,0x3c ; $8eec
	dc.b	0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c ; $8ef4
	dc.b	0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c ; $8efc
	dc.b	0x88,0x34,0x65,0x34,0x65,0x35,0x65,0x36 ; $8f04
	dc.b	0x65,0x3a,0x65,0x36,0x65,0x3f,0x60,0xfe ; $8f0c
	dc.b	0x02,0x09,0x8c,0x16,0x3c,0x10,0x3c,0x10 ; $8f14
	dc.b	0x3c,0x00,0x3d,0x10,0x3d,0x10,0x0c,0x15 ; $8f1c
	dc.b	0x0d,0x15,0x3c,0x00,0x3d,0x10,0x04,0x15 ; $8f24
	dc.b	0x05,0x15,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8f2c
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $8f34
	dc.b	0x37,0x65,0x38,0x65,0x33,0x65,0x3f,0x60 ; $8f3c
	dc.b	0x3a,0x65,0x3f,0x60,0x39,0x65,0x3f,0x60 ; $8f44
	dc.b	0x3f,0x60,0xfe,0x02,0x0a,0x8c,0x16,0x3c ; $8f4c
	dc.b	0x10,0x3c,0x10,0x3c,0x00,0x1c,0x15,0x3d ; $8f54
	dc.b	0x10,0x0e,0x15,0x0f,0x15,0x12,0x15,0x3d ; $8f5c
	dc.b	0x10,0x0a,0x15,0x05,0x15,0x3c,0x10,0x3c ; $8f64
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c ; $8f6c
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c ; $8f74
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c ; $8f7c
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0xfe,0x02,0x0b ; $8f84
	dc.b	0x8c,0x16,0x3c,0x10,0x3c,0x10,0x1b,0x15 ; $8f8c
	dc.b	0x1e,0x15,0x3d,0x10,0x10,0x15,0x11,0x15 ; $8f94
	dc.b	0x13,0x15,0x3d,0x10,0x06,0x15,0x05,0x15 ; $8f9c
	dc.b	0x3d,0x00,0x3f,0xfd,0x3d,0x00,0x3d,0x00 ; $8fa4
	dc.b	0x3d,0x00,0x3f,0xfd,0x27,0x15,0x3c,0x10 ; $8fac
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10 ; $8fb4
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10 ; $8fbc
	dc.b	0xfe,0x02,0x0c,0x8c,0x16,0x3c,0x10,0x3c ; $8fc4
	dc.b	0x10,0x3c,0x00,0x3d,0x10,0x3d,0x10,0x3c ; $8fcc
	dc.b	0x00,0x3c,0x00,0x3c,0x00,0x3d,0x10,0x0a ; $8fd4
	dc.b	0x15,0x05,0x15,0xfe,0x15,0x0c,0x27,0x15 ; $8fdc
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10 ; $8fe4
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10 ; $8fec
	dc.b	0xfe,0x02,0x0d,0x8c,0x16,0x3c,0x10,0x3c ; $8ff4
	dc.b	0x10,0x1b,0x15,0x3d,0x10,0x3d,0x10,0x3c ; $8ffc
	dc.b	0x00,0x3c,0x00,0x3c,0x00,0x1c,0x15,0x08 ; $9004
	dc.b	0x15,0x09,0x15,0x3e,0x10,0x28,0x15,0x29 ; $900c
	dc.b	0x15,0x2a,0x15,0x3e,0x10,0x3e,0x10,0x3b ; $9014
	dc.b	0xfd,0x3c,0xfd,0x27,0x15,0x3c,0x10,0x3c ; $901c
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c ; $9024
	dc.b	0x10,0x3c,0x10,0xfe,0x02,0x0e,0x8c,0x16 ; $902c
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x00,0x3d,0x10 ; $9034
	dc.b	0x1c,0x15,0x3c,0x00,0x3c,0x00,0x3c,0x00 ; $903c
	dc.b	0x1e,0x15,0x07,0x15,0xfe,0x14,0x0e,0x3d ; $9044
	dc.b	0xfd,0x3e,0xfd,0x3e,0x10,0x27,0x15,0x3c ; $904c
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0x3c,0x10,0x3c ; $9054
	dc.b	0x10,0x3c,0x10,0xfe,0x02,0x0f,0x8c,0x16 ; $905c
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x00,0x3d,0x10 ; $9064
	dc.b	0x1e,0x15,0x14,0x75,0x15,0x75,0x3c,0x00 ; $906c
	dc.b	0x0b,0x15,0x3e,0x10,0x28,0x15,0x29,0x15 ; $9074
	dc.b	0x2a,0x15,0xfe,0x16,0x0f,0x2b,0x15,0x3e ; $907c
	dc.b	0x10,0x27,0x15,0x3c,0x10,0x3c,0x10,0x3c ; $9084
	dc.b	0x10,0x3c,0x10,0x3c,0x10,0xfe,0x02,0x10 ; $908c
	dc.b	0x8c,0x16,0x3c,0x10,0x3c,0x10,0x1b,0x15 ; $9094
	dc.b	0x3d,0x10,0x3d,0x10,0x16,0x25,0x17,0x25 ; $909c
	dc.b	0xfe,0x13,0x10,0x2b,0x15,0xfe,0x19,0x10 ; $90a4
	dc.b	0x27,0x15,0x3c,0x10,0x3c,0x10,0x3c,0x10 ; $90ac
	dc.b	0x3c,0x10,0xfe,0x02,0x11,0x8c,0x16,0x3c ; $90b4
	dc.b	0x10,0x3c,0x10,0x3c,0x00,0x3d,0x10,0x3d ; $90bc
	dc.b	0x10,0x18,0x25,0x19,0xbd,0x2f,0x15,0xfe ; $90c4
	dc.b	0x18,0x11,0x2b,0x15,0x3e,0x10,0x27,0x15 ; $90cc
	dc.b	0x3c,0x10,0x3c,0x10,0x3c,0x10,0xfe,0x02 ; $90d4
	dc.b	0x12,0x8c,0x16,0x3c,0x10,0x3c,0x10,0x3c ; $90dc
	dc.b	0x00,0x1c,0x15,0x3d,0x10,0x1a,0xbd,0xfe ; $90e4
	dc.b	0x17,0x12,0x2b,0x15,0x3e,0x10,0x3e,0x10 ; $90ec
	dc.b	0x2b,0x15,0x27,0x15,0x3c,0x10,0x3c,0x10 ; $90f4
	dc.b	0xfe,0x02,0x13,0x8c,0x16,0x3c,0x10,0x3c ; $90fc
	dc.b	0x10,0x3c,0x00,0x1e,0x15,0x0b,0x15,0xfe ; $9104
	dc.b	0x1a,0x13,0x2f,0x15,0x3e,0x10,0x27,0x15 ; $910c
	dc.b	0x3c,0x10,0xfe,0x02,0x14,0x8c,0x16,0x3c ; $9114
	dc.b	0x10,0x3c,0x10,0x1b,0x15,0x0b,0x15,0x2f ; $911c
	dc.b	0x15,0x28,0x15,0x29,0x15,0x2a,0x15,0xfe ; $9124
	dc.b	0x19,0x14,0x2f,0x15,0x3e,0x10,0x2b,0x15 ; $912c
	dc.b	0x3e,0x10,0x27,0x15,0xfe,0x02,0x15,0x8c ; $9134
	dc.b	0x16,0x3c,0x10,0x26,0x15,0xfe,0x0f,0x15 ; $913c
	dc.b	0x2e,0x15,0x2f,0x15,0x2c,0x15,0x2d,0x15 ; $9144
	dc.b	0xfe,0x1a,0x15,0x2b,0x15,0x3e,0x10,0x2b ; $914c
	dc.b	0x15,0xfe,0x02,0x16,0x8c,0x16,0x26,0x15 ; $9154
	dc.b	0xfe,0x02,0x17,0x26,0x15,0xfe,0x1b,0x18 ; $915c
	dc.b	0x2b,0x15,0xfe,0x1a,0x19,0x2b,0x15,0xfe ; $9164
	dc.b	0x09,0x1a,0x2e,0x15,0x2f,0x15,0x2c,0x15 ; $916c
	dc.b	0x2d,0x15,0xfe,0x07,0x1d,0x2f,0x15,0xfe ; $9174
	dc.b	0x17,0x1d,0x2f,0x15,0xff,0x02,0x00,0x3f ; $917c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0xfe,0x1b,0x00 ; $9184
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0xfe,0x02 ; $918c
	dc.b	0x01,0x3f,0x90,0x3f,0x90,0x3f,0x90,0xfe ; $9194
	dc.b	0x1b,0x01,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $919c
	dc.b	0xfe,0x02,0x02,0x3f,0x90,0x3f,0x90,0x3f ; $91a4
	dc.b	0x90,0xfe,0x1b,0x02,0x3f,0x90,0x3f,0x90 ; $91ac
	dc.b	0x3f,0x90,0xfe,0x02,0x03,0x3f,0x90,0x3f ; $91b4
	dc.b	0x90,0x3f,0x90,0xfe,0x1b,0x03,0x3f,0x90 ; $91bc
	dc.b	0x3f,0x90,0x3f,0x90,0xfe,0x02,0x04,0x3f ; $91c4
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0xfe,0x1b,0x04 ; $91cc
	dc.b	0x72,0x95,0x69,0x95,0x3f,0x90,0xfe,0x02 ; $91d4
	dc.b	0x05,0x3f,0x90,0x3f,0x90,0x3f,0x90,0xfe ; $91dc
	dc.b	0x1b,0x05,0x3d,0x90,0x68,0x95,0x3f,0x90 ; $91e4
	dc.b	0xfe,0x02,0x06,0x3f,0x90,0x3f,0x90,0x3f ; $91ec
	dc.b	0x90,0xfe,0x1b,0x06,0x67,0x95,0x3f,0x90 ; $91f4
	dc.b	0x3f,0x90,0xfe,0x02,0x07,0x3f,0x90,0x3f ; $91fc
	dc.b	0x90,0x3f,0x90,0xfe,0x1b,0x07,0x3f,0x90 ; $9204
	dc.b	0x3f,0x90,0x3f,0x90,0xfe,0x02,0x08,0x6c ; $920c
	dc.b	0x95,0x72,0x95,0x69,0x95,0x6d,0x95,0x71 ; $9214
	dc.b	0x95,0x6d,0x95,0x72,0x95,0x69,0x95,0x3f ; $921c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $9224
	dc.b	0x90,0x3f,0x90,0x65,0x95,0x3d,0x90,0x6a ; $922c
	dc.b	0x95,0x6f,0x95,0x6a,0x95,0x6b,0x95,0x6a ; $9234
	dc.b	0x95,0x66,0x95,0x67,0x95,0x3f,0x90,0x3f ; $923c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0xfe ; $9244
	dc.b	0x02,0x09,0x3d,0x90,0x6a,0x95,0x6f,0x95 ; $924c
	dc.b	0x6f,0x95,0x6a,0x95,0x6b,0x95,0x66,0x95 ; $9254
	dc.b	0x67,0x95,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $925c
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $9264
	dc.b	0x6e,0x95,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $926c
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $9274
	dc.b	0x6c,0x95,0x6d,0x95,0x72,0x95,0x69,0x95 ; $927c
	dc.b	0x71,0x95,0xfe,0x02,0x0a,0x6e,0x95,0x3f ; $9284
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $928c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $9294
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $929c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $92a4
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $92ac
	dc.b	0x90,0x65,0x95,0x66,0x95,0x70,0x95,0x6a ; $92b4
	dc.b	0x95,0x6a,0x95,0x68,0x95,0xfe,0x02,0x0b ; $92bc
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92c4
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92cc
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92d4
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92dc
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92e4
	dc.b	0x40,0x8d,0x41,0x8d,0x3f,0x90,0x3f,0x90 ; $92ec
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90 ; $92f4
	dc.b	0xfe,0x02,0x0c,0x5d,0x95,0x5e,0x95,0x5f ; $92fc
	dc.b	0x95,0x60,0x95,0x5d,0x95,0x61,0x95,0x3f ; $9304
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $930c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $9314
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $931c
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x42,0x8d,0x3f ; $9324
	dc.b	0x90,0x3f,0x90,0x3f,0x90,0x3f,0x90,0x3f ; $932c
	dc.b	0x90,0x3f,0x90,0xfe,0x02,0x0d,0x3c,0x90 ; $9334
	dc.b	0x3c,0x90,0x3c,0x90,0x3c,0x90,0x3c,0x90 ; $933c
	dc.b	0x3c,0x90,0x64,0x95,0x62,0x95,0x63,0x95 ; $9344
	dc.b	0x62,0x95,0x63,0x95,0x61,0x95,0x5d,0x95 ; $934c
	dc.b	0x5f,0x95,0x5f,0x95,0x60,0x95,0x3f,0x90 ; $9354
	dc.b	0x3f,0x90,0x3f,0x90,0x43,0x95,0x43,0x95 ; $935c
	dc.b	0x44,0x95,0x45,0x95,0x46,0x95,0x3f,0x90 ; $9364
	dc.b	0x3f,0x90,0x3f,0x90,0x3f,0x90,0xfe,0x07 ; $936c
	dc.b	0x0e,0x54,0xfd,0x53,0xfd,0x52,0xfd,0x51 ; $9374
	dc.b	0xfd,0x50,0xfd,0x4f,0xfd,0x4e,0xfd,0x4d ; $937c
	dc.b	0xfd,0x4c,0xfd,0xfe,0x12,0x0e,0x4b,0xf5 ; $9384
	dc.b	0xfe,0x16,0x0e,0x4b,0xf5,0xfe,0x1a,0x0e ; $938c
	dc.b	0x4b,0xf5,0xfe,0x02,0x0f,0x51,0xfd,0x50 ; $9394
	dc.b	0xfd,0x4f,0xfd,0x4e,0xfd,0x55,0xfd,0x55 ; $939c
	dc.b	0xfd,0x5a,0x05,0x5b,0x05,0x5c,0x05,0x55 ; $93a4
	dc.b	0xfd,0x4d,0xfd,0x4c,0xfd,0xfe,0x02,0x10 ; $93ac
	dc.b	0x55,0xfd,0x55,0xfd,0x55,0xfd,0x58,0x05 ; $93b4
	dc.b	0x59,0x05,0x57,0x05,0x55,0xfd,0x55,0xfd ; $93bc
	dc.b	0x4d,0xfd,0x4c,0xfd,0xfe,0x0f,0x10,0x4b ; $93c4
	dc.b	0xf5,0xfe,0x14,0x10,0x4b,0xf5,0xfe,0x02 ; $93cc
	dc.b	0x11,0x56,0x05,0x57,0x05,0x55,0xfd,0x55 ; $93d4
	dc.b	0xfd,0x55,0xfd,0x55,0xfd,0x4d,0xfd,0x4c ; $93dc
	dc.b	0xfd,0xfe,0x0c,0x11,0x4b,0xf5,0xfe,0x16 ; $93e4
	dc.b	0x11,0x4b,0xf5,0xfe,0x19,0x11,0x4b,0xf5 ; $93ec
	dc.b	0xfe,0x02,0x12,0x55,0xfd,0x55,0xfd,0x55 ; $93f4
	dc.b	0xfd,0x55,0xfd,0x4d,0xfd,0x4c,0xfd,0xfe ; $93fc
	dc.b	0x1b,0x12,0x4b,0xf5,0xfe,0x02,0x13,0x55 ; $9404
	dc.b	0xfd,0x55,0xfd,0x4d,0xfd,0x4c,0xfd,0xfe ; $940c
	dc.b	0x02,0x14,0x4d,0xfd,0x4c,0xfd,0xfe,0x06 ; $9414
	dc.b	0x14,0x4a,0xf5,0xfe,0x09,0x15,0x4a,0xf5 ; $941c
	dc.b	0xfe,0x0f,0x16,0x4a,0xf5,0xfe,0x17,0x16 ; $9424
	dc.b	0x4a,0xf5,0xfe,0x0a,0x1b,0x48,0xf5,0x49 ; $942c
	dc.b	0xf5,0xfe,0x13,0x1c,0x48,0xf5,0x49,0xf5 ; $9434
	dc.b	0xfe,0x18,0x1c,0x48,0xf5,0x49,0xf5,0xfe ; $943c
	dc.b	0x0f,0x1c,0x48,0xf5,0x49,0xf5,0xff,0x02 ; $9444
	dc.b	0x00,0x3d,0x18,0x3d,0x18,0x3d,0x18,0xfe ; $944c
	dc.b	0x1b,0x00,0x3d,0x18,0x3d,0x18,0x3d,0x18 ; $9454
	dc.b	0xfe,0x02,0x01,0x3d,0x18,0x3d,0x18,0x3d ; $945c
	dc.b	0x18,0xfe,0x1b,0x01,0x3d,0x18,0x7b,0x1d ; $9464
	dc.b	0x3d,0x18,0xfe,0x02,0x02,0x7b,0x1d,0x7c ; $946c
	dc.b	0x1d,0x7d,0x1d,0xfe,0x1b,0x02,0x7e,0x1d ; $9474
	dc.b	0x3d,0x18,0x3d,0x18,0xfe,0x02,0x03,0x3d ; $947c
	dc.b	0x18,0x3d,0x18,0x3d,0x18,0xfe,0x1b,0x03 ; $9484
	dc.b	0x3d,0x18,0x3d,0x18,0x3d,0x18,0xfe,0x02 ; $948c
	dc.b	0x04,0x3d,0x18,0x3d,0x18,0x7b,0x1d,0xfe ; $9494
	dc.b	0x1b,0x04,0x80,0x1d,0x3d,0x18,0x3d,0x18 ; $949c
	dc.b	0xfe,0x02,0x05,0x3d,0x18,0x3d,0x18,0x3d ; $94a4
	dc.b	0x18,0xfe,0x1b,0x05,0x80,0x1d,0x7d,0x1d ; $94ac
	dc.b	0x7e,0x1d,0xfe,0x02,0x06,0x3c,0x00,0x3c ; $94b4
	dc.b	0x00,0xad,0xcd,0xfe,0x1b,0x06,0x80,0x1d ; $94bc
	dc.b	0x3d,0x18,0x3d,0x18,0xfe,0x02,0x07,0x3c ; $94c4
	dc.b	0x00,0x3c,0x00,0xac,0xcd,0xfe,0x1b,0x07 ; $94cc
	dc.b	0x3c,0x00,0x3d,0x18,0x3d,0x18,0xfe,0x02 ; $94d4
	dc.b	0x08,0x3c,0x00,0x3c,0x00,0xac,0xcd,0xac ; $94dc
	dc.b	0xcd,0xac,0xcd,0xac,0xcd,0x7c,0x1d,0x7d ; $94e4
	dc.b	0x1d,0x7e,0x1d,0x3d,0x18,0x3d,0x18,0x3d ; $94ec
	dc.b	0x18,0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d ; $94f4
	dc.b	0x18,0x3d,0x18,0x3d,0x18,0x7f,0x1d,0x80 ; $94fc
	dc.b	0x1d,0x3c,0x00,0x3c,0x00,0x3c,0x00,0x80 ; $9504
	dc.b	0x1d,0x7f,0x1d,0x80,0x1d,0x3d,0x18,0x3d ; $950c
	dc.b	0x18,0xfe,0x02,0x09,0x3c,0x00,0x3c,0x00 ; $9514
	dc.b	0xac,0xcd,0xac,0xcd,0xac,0xcd,0xac,0xcd ; $951c
	dc.b	0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d,0x18 ; $9524
	dc.b	0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d,0x18 ; $952c
	dc.b	0x7b,0x1d,0x7c,0x1d,0x7d,0x1d,0x7e,0x1d ; $9534
	dc.b	0x7f,0x1d,0x80,0x1d,0x7f,0x1d,0x80,0x1d ; $953c
	dc.b	0x7f,0x1d,0x3c,0x00,0x7f,0x1d,0x80,0x1d ; $9544
	dc.b	0x3d,0x18,0x3d,0x18,0xfe,0x02,0x0a,0x3c ; $954c
	dc.b	0x00,0x3c,0x00,0xac,0xcd,0xac,0xcd,0xac ; $9554
	dc.b	0xcd,0xac,0xcd,0x3d,0x18,0x3d,0x18,0x3d ; $955c
	dc.b	0x18,0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d ; $9564
	dc.b	0x18,0x7e,0x1d,0x3d,0x18,0x3d,0x18,0x3d ; $956c
	dc.b	0x18,0x3d,0x18,0x7f,0x1d,0x80,0x1d,0x7f ; $9574
	dc.b	0x1d,0x80,0x1d,0x7f,0x1d,0x3e,0x18,0x7f ; $957c
	dc.b	0x1d,0x80,0x1d,0x81,0x1d,0x82,0x1d,0xfe ; $9584
	dc.b	0x02,0x0b,0x3c,0x00,0x3c,0x00,0xac,0xcd ; $958c
	dc.b	0xac,0xcd,0xac,0xcd,0xac,0xcd,0xa2,0x15 ; $9594
	dc.b	0xa2,0x15,0xa2,0x15,0xa1,0x1d,0x3d,0x18 ; $959c
	dc.b	0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d,0x18 ; $95a4
	dc.b	0x3d,0x18,0x3d,0x18,0x3d,0x18,0x7f,0x1d ; $95ac
	dc.b	0x80,0x1d,0x7f,0x1d,0x80,0x1d,0x3c,0x00 ; $95b4
	dc.b	0x3c,0x00,0x81,0x1d,0x82,0x1d,0x85,0x1d ; $95bc
	dc.b	0x86,0x1d,0xfe,0x02,0x0c,0x3c,0x00,0x3c ; $95c4
	dc.b	0x00,0xac,0xcd,0xac,0xcd,0xac,0xcd,0xac ; $95cc
	dc.b	0xcd,0xa2,0x15,0xa2,0x15,0xa2,0x15,0xa0 ; $95d4
	dc.b	0x15,0x3d,0x18,0x9f,0x1d,0x9d,0x1d,0x99 ; $95dc
	dc.b	0x1d,0x3d,0x18,0x3d,0x18,0x3d,0x18,0x3d ; $95e4
	dc.b	0x18,0x3c,0x00,0x80,0x1d,0x3c,0x00,0x80 ; $95ec
	dc.b	0x1d,0x7f,0x1d,0x80,0x1d,0x87,0x1d,0x88 ; $95f4
	dc.b	0x1d,0x89,0x1d,0x8a,0x1d,0xfe,0x02,0x0d ; $95fc
	dc.b	0xab,0x15,0xab,0x15,0xab,0x15,0xab,0x15 ; $9604
	dc.b	0xab,0x15,0xa6,0x15,0xa3,0x15,0xa4,0x15 ; $960c
	dc.b	0xa2,0x15,0x9b,0x1d,0x93,0xe5,0x3d,0x10 ; $9614
	dc.b	0x93,0xe5,0x9b,0x1d,0x3d,0x18,0x93,0xe5 ; $961c
	dc.b	0x94,0x1d,0x3d,0x18,0x7f,0x1d,0x3c,0x00 ; $9624
	dc.b	0x3c,0x00,0x80,0x1d,0x7f,0x1d,0x80,0x1d ; $962c
	dc.b	0x8b,0x1d,0x8c,0x1d,0x8d,0x1d,0x8e,0x1d ; $9634
	dc.b	0xfe,0x02,0x0e,0x3e,0x58,0x3e,0x58,0x3e ; $963c
	dc.b	0x58,0x3e,0x58,0xa7,0x5d,0x3e,0x58,0xaa ; $9644
	dc.b	0x5d,0xa2,0x15,0xa2,0x15,0x9c,0x1d,0x93 ; $964c
	dc.b	0xe5,0x93,0xe5,0x93,0xe5,0x9c,0x1d,0x3d ; $9654
	dc.b	0x18,0x93,0xe5,0x96,0x1d,0x92,0x1d,0x7f ; $965c
	dc.b	0x1d,0x80,0x1d,0x7f,0x1d,0x80,0x1d,0x7f ; $9664
	dc.b	0x1d,0x3c,0x00,0x8f,0x1d,0x90,0x1d,0x91 ; $966c
	dc.b	0x1d,0x84,0x1d,0xfe,0x02,0x0f,0xa9,0x5d ; $9674
	dc.b	0xa9,0x5d,0xa9,0x5d,0xa9,0x5d,0xa8,0x5d ; $967c
	dc.b	0xa9,0x5d,0xaa,0x5d,0xa2,0x15,0xa2,0x15 ; $9684
	dc.b	0x9e,0x1d,0x3d,0x10,0x93,0xe5,0x93,0xe5 ; $968c
	dc.b	0x9e,0x1d,0x98,0x25,0x93,0xe5,0x97,0x1d ; $9694
	dc.b	0x3c,0x00,0x7f,0x1d,0x80,0x1d,0x7f,0x1d ; $969c
	dc.b	0x80,0x1d,0x7f,0x1d,0x3c,0x00,0x83,0x1d ; $96a4
	dc.b	0x84,0x1d,0x84,0x1d,0x84,0x1d,0xfe,0x02 ; $96ac
	dc.b	0x10,0xa9,0x5d,0xa9,0x5d,0xa9,0x5d,0xa9 ; $96b4
	dc.b	0x5d,0xa8,0x5d,0xa9,0x5d,0xaa,0x5d,0xa2 ; $96bc
	dc.b	0x15,0xa2,0x15,0x9e,0x1d,0x3d,0x10,0x3d ; $96c4
	dc.b	0x10,0x3d,0x10,0x9e,0x1d,0x9a,0x25,0x93 ; $96cc
	dc.b	0xe5,0x3c,0x00,0x3c,0x00,0x3c,0x00,0x3c ; $96d4
	dc.b	0x00,0x3c,0x00,0x3c,0x00,0x3c,0x00,0x3c ; $96dc
	dc.b	0x00,0x83,0x1d,0x84,0x1d,0x84,0x1d,0x84 ; $96e4
	dc.b	0x1d,0xfe,0x02,0x11,0x3f,0xd8,0x3f,0xd8 ; $96ec
	dc.b	0x75,0xdd,0x76,0xdd,0x73,0xdd,0x74,0xdd ; $96f4
	dc.b	0xfe,0x18,0x11,0x77,0xdd,0x78,0xdd,0x79 ; $96fc
	dc.b	0xdd,0x7a,0xdd,0x3f,0xd8,0x3f,0xd8,0xfe ; $9704
	dc.b	0x02,0x12,0x73,0xdd,0x74,0xdd,0xfe,0x1c ; $970c
	dc.b	0x12,0x77,0xdd,0x78,0xdd,0xff,0x02,0x00 ; $9714
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe,0x1b ; $971c
	dc.b	0x00,0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe ; $9724
	dc.b	0x02,0x01,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $972c
	dc.b	0xfe,0x1b,0x01,0x3c,0x88,0x3c,0x88,0x3c ; $9734
	dc.b	0x88,0xfe,0x02,0x02,0xae,0x95,0xae,0x95 ; $973c
	dc.b	0xae,0x95,0xfe,0x1b,0x02,0x3c,0x88,0x3c ; $9744
	dc.b	0x88,0x3c,0x88,0xfe,0x02,0x03,0xaf,0x15 ; $974c
	dc.b	0xaf,0x15,0xaf,0x15,0xfe,0x1b,0x03,0x3c ; $9754
	dc.b	0x88,0x3c,0x88,0x3c,0x88,0xfe,0x02,0x04 ; $975c
	dc.b	0xaf,0x15,0xaf,0x15,0xaf,0x15,0xfe,0x1b ; $9764
	dc.b	0x04,0x3c,0x88,0x3c,0x88,0x3c,0x88,0xfe ; $976c
	dc.b	0x02,0x05,0xaf,0x15,0xaf,0x15,0xaf,0x15 ; $9774
	dc.b	0xfe,0x1b,0x05,0x3c,0x88,0x3c,0x88,0x3c ; $977c
	dc.b	0x88,0xfe,0x02,0x06,0xb0,0x15,0xb0,0x15 ; $9784
	dc.b	0xb0,0x15,0xfe,0x1b,0x06,0x3c,0x88,0x3c ; $978c
	dc.b	0x88,0x3c,0x88,0xfe,0x02,0x07,0x3f,0x00 ; $9794
	dc.b	0x3f,0x00,0x3f,0x00,0xfe,0x1b,0x07,0xc4 ; $979c
	dc.b	0xdd,0xc5,0xdd,0xc6,0xdd,0xfe,0x02,0x08 ; $97a4
	dc.b	0x3f,0x00,0x3f,0x00,0x3f,0x00,0x3f,0x00 ; $97ac
	dc.b	0x3f,0x00,0x3f,0x00,0x3f,0x00,0x3f,0x00 ; $97b4
	dc.b	0x3f,0x00,0x3f,0x00,0x3f,0x00,0x3f,0x00 ; $97bc
	dc.b	0x3f,0x00,0x3f,0x00,0x3f,0x00,0x3f,0x00 ; $97c4
	dc.b	0x3f,0x00,0x3f,0x00,0x3c,0x88,0x3c,0x88 ; $97cc
	dc.b	0x3c,0x88,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $97d4
	dc.b	0x3c,0x88,0xcd,0xdd,0xce,0xdd,0xcf,0xdd ; $97dc
	dc.b	0xfe,0x02,0x09,0x3f,0x00,0x3f,0x00,0xb1 ; $97e4
	dc.b	0x05,0xb2,0x05,0x3f,0x00,0x3f,0x00,0xb1 ; $97ec
	dc.b	0x05,0xb2,0x05,0x3f,0x00,0x3f,0x00,0xb1 ; $97f4
	dc.b	0x05,0xb2,0x05,0x3f,0x00,0x3f,0x00,0xb1 ; $97fc
	dc.b	0x05,0xb2,0x05,0x3f,0x00,0x3f,0x00,0x3c ; $9804
	dc.b	0x88,0x3c,0x88,0xb9,0x8d,0xb8,0x8d,0xbf ; $980c
	dc.b	0x8d,0xc0,0x8d,0x3c,0x88,0xe4,0xdd,0xe5 ; $9814
	dc.b	0xdd,0xe6,0xdd,0xfe,0x02,0x0a,0x3f,0x00 ; $981c
	dc.b	0x3f,0x00 ; $9824
table_9826:
	dc.b	0x3c,0x00,0xb3,0x05,0x3f,0x00,0x3f,0x00 ; $9826
...
table_a00c:
	...
	dc.b	0x3e,0x78,0x3e,0x78,0x3e ; $a014
table_a019:
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a019
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a021
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a029
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0xfe ; $a031
	dc.b	0x02,0x1d,0x3e,0x78 ; $a039
table_a03d:
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a03d
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a045
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a04d
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a055
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a05d
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a065
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0xfe,0x02 ; $a06d
	dc.b	0x1e,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a075
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a07d
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a085
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a08d
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a095
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a09d
	dc.b	0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e ; $a0a5
	dc.b	0x78,0xfe,0x02,0x1f,0x3e,0x78,0x3e,0x78 ; $a0ad
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0b5
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0bd
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0c5
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0cd
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0d5
	dc.b	0x3e,0x78,0x3e,0x78,0x3e,0x78,0x3e,0x78 ; $a0dd
	dc.b	0x3e,0x78,0x3e,0x78,0xff ; $a0e5
table_a0ea:
	dc.b	0x0c,0x02,0x3f,0x18,0xbd,0x19,0xbe,0x19 ; $a0ea
...
table_a260:
	dc.b	0x02,0x1c,0x3c,0x98,0x3c,0x98,0x3c,0x98 ; $a260
...
table_A529:
	dc.b	0x58,0x17,0x40,0x17,0x28,0x17,0x00,0x27 ; $a529
...
A5B1:
	...
	dc.b	0x75,0xb0,0x25,0xa7,0x3f,0xa7,0x86,0xa7 ; $a5d9
	...
	dc.b	0x75,0xb0,0x33,0xaa,0x33,0xaa,0x33,0xaa ; $a651
...
walk_frames_list_AA3B:
	dc.b	0x89,0x0a,0x92,0x0a,0x9b,0x0a,0xa4,0x0a ; $aa3b
	dc.b	0xad,0x0a,0xb6,0x0a,0xbf,0x0a,0xc8,0x0a ; $aa43
	dc.b	0xff,0xff ; $aa4b
jump_frames_list_AA4D:
	dc.b	0x22,0x0b,0x8e,0x0b,0x97,0x0b,0xa0,0x0b ; $aa4d
...
hitting_frame_list_AA6D:
	dc.b	0xc0,0x0c,0xd2,0x0c,0x47,0x0d,0xd7,0x0d ; $aa6d
...
blocking_frame_list_AA8D:
	dc.b	0x88,0x1a,0xd0,0x1a,0x18,0x1b,0xff,0xff ; $aa8d
	;       uchiuke   sotouke     gedanbarai
	;       (high)    (medium)    (low)
forward_sommersault_frame_list_AA95:
	dc.b	0xad,0x13,0xb6,0x13,0xbf,0x13,0xc8,0x13 ; $aa95
...
backwards_sommersault_frame_list_AAA5:
	dc.b	0x45,0x12,0x4e,0x12 ; $aaa5
	 ;     start  next frame
backwards_sommersault_frame_list_end_AAA9:
	dc.b	0x57,0x12,0x60,0x12,0x72,0x12,0x7b,0x12 ; $aaa9
	dc.b	0xff,0xff ; $aab1
...
crouch_frame_list_AAB3:
	dc.b	0x27,0x0c,0xe0,0x0d,0xa7,0x10,0xde,0x12 ; $aab3
	dc.b	0xff,0xff ; $aabb
...
table_AABD:
	dc.b	0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b ; $aabd
	dc.b	0x0c,0x0d,0x0e,0xff ; $aac5
table_AAC9:
	dc.b	0x01,0x02,0x03,0xff ; $aac9
table_high_attacks_AACD:
	dc.b	0x02,0x06,0x08,0x0a,0x0b,0x0c,0xff ; $aacd
table_low_attacks_AAD4:
	dc.b	0x03,0x09,0x0e,0xff ; $aad4
table_sommersaults_AAD8:
	dc.b	0x10,0x11,0x12,0xff ; $aad8
...
move_list_far_away_AB62:
	...
	dc.b	0x0d,0x05,0x08,0x09,0x0a,0x0b,0x0c,0x0d ; $ab62
...
move_list_facing_mid_range_AB70:
	dc.b	0x0a,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,0x10 ; $ab70
...
move_list_facing_close_range_AB7B:
	...
	dc.b	0x08,0x0a,0x0b,0x0c,0x0d,0x0f,0x10,0x13 ; $ab7b
	dc.b	0x14 ; $ab83
...
AD55: C5          push bc
AD56: 3E 01       ld   a,$01
AD58: CD 5A B0    call wait_a_few_frames_B05A
AD5B: C1          pop  bc
AD5C: FD E1       pop  iy
AD5E: A7          and  a
...
B176: FD E5       push iy
B178: F5          push af
B179: CD 67 B5    call bitfield_clear_B5CD
B17C: F1          pop  af
B17D: 3C          inc  a
B17E: FE 12       cp   $18
...
B4DE: CB 03       rlc  e
B4E0: 16 00       ld   d,$00
B4E2: FD 21 85 B2 ld   iy,ram_address_table_B825
...
; sets bits but way further than $C00B...
bitfield_manipulation_B6AE:
...
table_B7E5:
	dc.b	0x00,0xc1,0x20,0xc1,0x40,0xc1,0x60,0xc1 ; $b7e5
	dc.b	0x80,0xc1,0xa0,0xc1,0xc0,0xc1,0xe0,0xc1 ; $b7ed
	dc.b	0x00,0xc2,0x20,0xc2,0x40,0xc2,0x60,0xc2 ; $b7f5
	dc.b	0x80,0xc2,0xa0,0xc2,0xc0,0xc2,0xe0,0xc2 ; $b7fd
	dc.b	0x00,0xc3,0x20,0xc3,0x40,0xc3,0x60,0xc3 ; $b805
	dc.b	0x80,0xc3,0xa0,0xc3,0xc0,0xc3,0xe0,0xc3 ; $b80d
	dc.b	0x00,0xc4,0x20,0xc4,0x40,0xc4,0x60,0xc4 ; $b815
	dc.b	0x80,0xc4,0xa0,0xc4,0xc0,0xc4,0xe0,0xc4 ; $b81d
...
BADF: AF          xor  a
BAE0: 06 0C       ld   b,$06
BAE2: CD AE BC    call bitfield_manipulation_B6AE
BAE5: C9          ret
BAE6: A7          and  a
...
BB65: AF          xor  a
BB66: CD 80 BC    call bitfield_set_B620
BB69: 3E 20       ld   a,$80
...
table_E008:
	dc.b	0x00,0x00,0xfa,0xd2,0xe7 ; $e008
...
E017: 3E 01       ld   a,$01
E019: 06 01       ld   b,$01
E01B: CD AE BC    call bitfield_manipulation_B6AE
...
E032: F5          push af
E033: 3E 15       ld   a,$15
E035: CD 80 BC    call bitfield_set_B620
E038: 3E 1C       ld   a,$16
E03A: CD 80 BC    call bitfield_set_B620
E03D: 3E 1D       ld   a,$17
E03F: CD 80 BC    call bitfield_set_B620
E042: 3E 01       ld   a,$01
E044: CD 5E BC    call wait_a_few_frames_B65E
E047: F1          pop  af
E048: 47          ld   b,a
E049: F5          push af
E04A: 3E 15       ld   a,$15
E04C: CD AE BC    call bitfield_manipulation_B6AE
E04F: F1          pop  af
E050: 47          ld   b,a
E051: F5          push af
E052: 3E 1C       ld   a,$16
E054: CD AE BC    call bitfield_manipulation_B6AE
E057: F1          pop  af
E058: 47          ld   b,a
E059: 3E 1D       ld   a,$17
E05B: CD AE BC    call bitfield_manipulation_B6AE
...
E0D7: CD 5E BC    call wait_a_few_frames_B65E
...
E0EC: DD E5       push ix
E0EE: FD E5       push iy
E0F0: CD AE BC    call bitfield_manipulation_B6AE
E0F3: FD E1       pop  iy
E0F5: DD E1       pop  ix
...
E10D: DD E5       push ix
E10F: AF          xor  a
E110: CD 5E BC    call wait_a_few_frames_B65E
E113: DD E1       pop  ix
E115: FD E1       pop  iy
E117: DD 23       inc  ix
E119: DD E5       push ix
...
E183: DD E5       push ix
E185: FD E5       push iy
E187: CD 5E BC    call wait_a_few_frames_B65E
E18A: FD E1       pop  iy
E18C: E1          pop  hl
...
E1DE: AF          xor  a
E1DF: CD 5E BC    call wait_a_few_frames_B65E
E1E2: 06 00       ld   b,$00
E1E4: 4F          ld   c,a
E1E5: CB 21       sla  c
...
E1FB: AF          xor  a
E1FC: CD 5E BC    call wait_a_few_frames_B65E
E1FF: 06 00       ld   b,$00
E201: 4F          ld   c,a
E202: CB 21       sla  c
...
E281: 3E 0F       ld   a,$0F
E283: 06 01       ld   b,$01
E285: CD AE BC    call bitfield_manipulation_B6AE
E288: FD E1       pop  iy
E28A: 3E 09       ld   a,$03
E28C: CD 00 E9    call $E300
E28F: FD E5       push iy
E291: 3E 10       ld   a,$10
E293: CD 5E BC    call wait_a_few_frames_B65E
E296: FD E1       pop  iy
E298: 3E 0C       ld   a,$06
E29A: CD 00 E9    call $E300
E29D: FD E5       push iy
E29F: 3E 10       ld   a,$10
E2A1: CD 5E BC    call wait_a_few_frames_B65E
E2A4: FD E1       pop  iy
E2A6: 3E 09       ld   a,$03
E2A8: CD 00 E9    call $E300
E2AB: FD E5       push iy
E2AD: 3E 10       ld   a,$10
E2AF: CD 5E BC    call wait_a_few_frames_B65E
E2B2: FD E1       pop  iy
E2B4: 3E 0C       ld   a,$06
E2B6: CD 00 E9    call $E300
E2B9: FD E5       push iy
E2BB: 3E 10       ld   a,$10
E2BD: CD 5E BC    call wait_a_few_frames_B65E
E2C0: FD E1       pop  iy
E2C2: 3E 09       ld   a,$03
E2C4: CD 00 E9    call $E300
E2C7: FD E5       push iy
E2C9: 3E 10       ld   a,$10
E2CB: CD 5E BC    call wait_a_few_frames_B65E
E2CE: FD E1       pop  iy
E2D0: 3E 0C       ld   a,$06
E2D2: CD 00 E9    call $E300
E2D5: FD E5       push iy
E2D7: 3E 10       ld   a,$10
E2D9: CD 5E BC    call wait_a_few_frames_B65E
E2DC: FD E1       pop  iy
E2DE: 3E 09       ld   a,$03
E2E0: CD 00 E9    call $E300
E2E3: FD E5       push iy
E2E5: 3E 10       ld   a,$10
E2E7: CD 5E BC    call wait_a_few_frames_B65E
E2EA: FD E1       pop  iy
E2EC: 3E 04       ld   a,$04
E2EE: CD 00 E9    call $E300
E2F1: FD E5       push iy
E2F3: 3E 10       ld   a,$10
E2F5: CD 5E BC    call wait_a_few_frames_B65E
E2F8: FD E1       pop  iy
E2FA: 3E 20       ld   a,$80
...
E319: C9          ret
table_E320:
	dc.b	0x00,0x00,0xfa,0x31,0xf6,0xff ; $e320
table_E326:
	dc.b	0x00,0x00,0xf8,0x58,0xed ; $e326
E32B: 06 80       ld   b,$20
E32D: C5          push bc
...
E33C: CD 31 B9    call display_multicolor_text_B357
E33F: 21 FD E9    ld   hl,table_E3F7
E342: CD 31 B9    call display_multicolor_text_B357
E345: 3E 02       ld   a,$08
E347: CD 5E BC    call wait_a_few_frames_B65E
...
E358: CD 31 B9    call display_multicolor_text_B357
E35B: 21 89 E4    ld   hl,table_E423
E35E: CD 31 B9    call display_multicolor_text_B357
E361: 3E 02       ld   a,$08
E363: CD 5E BC    call wait_a_few_frames_B65E
E366: C1          pop  bc
E367: 10 64       djnz $E32D
E369: 3E 01       ld   a,$01
E36B: 06 01       ld   b,$01
E36D: CD AE BC    call bitfield_manipulation_B6AE
E370: CD A5 B5    call warm_reboot_B5A5
table_E373:
	dc.b	0x08,0x1d,0x0c,0xa0,0x11,0xa0,0x0a,0xa0 ; $e373
	...
	dc.b	0xff ; $e393
table_E394:
	dc.b	0x08,0x11,0x0c,0xa0,0x11,0xa0,0x0a,0xa0 ; $e394
	...
	dc.b	0xff ; $e3b4
table_E3B5:
	dc.b	0x08,0x1d,0x3c,0xa0,0x3c,0xa0,0x3c,0xa0 ; $e3b5
	...
	dc.b	0xff ; $e3d5
table_E3D6:
	dc.b	0x08,0x11,0x3c,0xa0,0x3c,0xa0,0x3c,0xa0 ; $e3d6
	...
	dc.b	0xff ; $e3f6
table_E3F7:
	dc.b	0x17,0x10,0x3c,0x88,0x3c,0x88,0x3c,0x88 ; $e3f7
...
table_E423:
	dc.b	0x17,0x10,0x3c,0x88,0xac,0x88,0xad,0x88 ; $e423
...
E4AF: FD E5       push iy
E4B1: 3E 04       ld   a,$04
E4B3: CD 5E BC    call wait_a_few_frames_B65E
E4B6: FD E1       pop  iy
...
E4C0: 3E 1D       ld   a,$17
E4C2: CD 67 B5    call bitfield_clear_B5CD
...
E4D3: CD 31 B9    call display_multicolor_text_B357
E4D6: C1          pop  bc
E4D7: 78          ld   a,b
E4D8: FE 0A       cp   $0A
...
E4EE: CD 31 B9    call display_multicolor_text_B357
E4F1: F1          pop  af
...
E51D: 3E 10       ld   a,$10
E51F: CD 5E BC    call wait_a_few_frames_B65E
E522: C1          pop  bc
...
E52D: 3E 01       ld   a,$01
E52F: CD 5E BC    call wait_a_few_frames_B65E
E532: 3E 0C       ld   a,$06
E534: 06 0C       ld   b,$06
E536: CD AE BC    call bitfield_manipulation_B6AE
E539: 3E 20       ld   a,$80
E53B: CD 5E BC    call wait_a_few_frames_B65E
E53E: 3E 01       ld   a,$01
E540: 06 01       ld   b,$01
E542: CD AE BC    call bitfield_manipulation_B6AE
E545: CD A5 B5    call warm_reboot_B5A5
table_E548:
	dc.b	0x0c,0x19,0xee,0xa3,0x3d,0xa0,0x3d,0xa0 ; $e548
	dc.b	0xee,0xa3,0xff ; $e550
table_E553:
	dc.b	0x0c,0x19,0xef,0xa3,0x3f,0xd8,0x3f,0xd8 ; $e553
...
E570: D3 A2       out  ($A8),a
E572: 3E 0C       ld   a,$06
E574: CD 80 BC    call bitfield_set_B620
E577: CD D4 B5    call load_iy_with_player_structure_B574
E57A: 3E 1C       ld   a,$16
E57C: CD 80 BC    call bitfield_set_B620
E57F: 3E 04       ld   a,$04
E581: CD 80 BC    call bitfield_set_B620
...
E593: 3E 90       ld   a,$30
E595: CD 5E BC    call wait_a_few_frames_B65E
...
E5AC: 3E 08       ld   a,$02
E5AE: CD 5E BC    call wait_a_few_frames_B65E
...
E5E8: 3E 01       ld   a,$01
E5EA: CD 5E BC    call wait_a_few_frames_B65E
E5ED: FD E1       pop  iy
E5EF: E1          pop  hl
E5F0: DD E1       pop  ix
E5F2: 2C          inc  l
...
E5FE: C5          push bc
E5FF: 3E 1C       ld   a,$16
E601: CD AE BC    call bitfield_manipulation_B6AE
E604: 3E 08       ld   a,$02
...
E61A: C5          push bc
E61B: 3E 40       ld   a,$40
E61D: CD 5E BC    call wait_a_few_frames_B65E
E620: C1          pop  bc
E621: 3E 04       ld   a,$04
E623: CD AE BC    call bitfield_manipulation_B6AE
E626: 3E 00       ld   a,$00
E628: CD 5E BC    call wait_a_few_frames_B65E
table_E62B:
	dc.b	0x08,0x1d,0x19,0xa0,0x0e,0xa0,0x1b,0xa0 ; $e62b
	...
	dc.b	0xff ; $e64b
table_E64C:
	dc.b	0x08,0x11,0x19,0xa0,0x0e,0xa0,0x1b,0xa0 ; $e64c
	...
	dc.b	0xff ; $e66c
table_E66D:
	dc.b	0xf8,0x01,0xfa,0x01,0xfb,0x02,0xfd,0x02 ; $e66d
...
E6E5: FD E5       push iy
E6E7: 3E 04       ld   a,$04
E6E9: CD 5E BC    call wait_a_few_frames_B65E
E6EC: FD E1       pop  iy
...
E6F6: 3E 1D       ld   a,$17
E6F8: CD 67 B5    call bitfield_clear_B5CD
E6FB: 21 D9 E9    ld   hl,table_E373
E6FE: CD 31 B9    call display_multicolor_text_B357
E701: C1          pop  bc
E702: 78          ld   a,b
E703: FE 0A       cp   $0A
...
E70E: CD 31 B9    call display_multicolor_text_B357
E711: F1          pop  af
...
E78C: FD E5       push iy
E78E: 3E 04       ld   a,$04
E790: CD 5E BC    call wait_a_few_frames_B65E
E793: FD E1       pop  iy
...
E79D: 3E 1D       ld   a,$17
E79F: CD 67 B5    call bitfield_clear_B5CD
E7A2: 21 D9 E9    ld   hl,table_E373
E7A5: CD 31 B9    call display_multicolor_text_B357
E7A8: C1          pop  bc
E7A9: 78          ld   a,b
E7AA: FE 0A       cp   $0A
...
E7B5: CD 31 B9    call display_multicolor_text_B357
E7B8: F1          pop  af
E7B9: CD AB B1    call $B1AB
E7BC: 3E 0C       ld   a,$06
E7BE: 06 0C       ld   b,$06
E7C0: CD AE BC    call bitfield_manipulation_B6AE
E7C3: 3E 20       ld   a,$80
E7C5: CD 5E BC    call wait_a_few_frames_B65E
E7C8: 3E 01       ld   a,$01
E7CA: 06 01       ld   b,$01
E7CC: CD AE BC    call bitfield_manipulation_B6AE
...
E87F: 3E 01       ld   a,$01
E881: CD 5E BC    call wait_a_few_frames_B65E
...
E8C3: 3E 01       ld   a,$01
E8C5: CD 5E BC    call wait_a_few_frames_B65E
E8C8: F1          pop  af
E8C9: DD E1       pop  ix
E8CB: FD E1       pop  iy
E8CD: E1          pop  hl
...
E900: 3E 08       ld   a,$02
E902: CD 5E BC    call wait_a_few_frames_B65E
E905: E1          pop  hl
E906: 3E 02       ld   a,$08
E908: 84          add  a,h
E909: 67          ld   h,a
...
E928: 3E 1D       ld   a,$17
E92A: CD AE BC    call bitfield_manipulation_B6AE
E92D: CD A5 B5    call warm_reboot_B5A5

E930: 3E 04       ld   a,$04
E932: CD 80 BC    call bitfield_set_B620
E935: AF          xor  a
...
E959: FD E5       push iy
E95B: 3E 04       ld   a,$04
E95D: CD 5E BC    call wait_a_few_frames_B65E
E960: FD E1       pop  iy
E962: FD 23       inc  iy
E964: FD 23       inc  iy
E966: FD 23       inc  iy
...
E96D: 3E 1C       ld   a,$16
E96F: CD 67 B5    call bitfield_clear_B5CD
E972: 21 D9 E9    ld   hl,table_E373
E975: CD 31 B9    call display_multicolor_text_B357
E978: C1          pop  bc
E979: 78          ld   a,b
E97A: FE 0A       cp   $0A
E97C: C2 38 E3    jp   nz,$E992
E97F: 21 8B EC    ld   hl,table_E62B
E982: CD 31 B9    call display_multicolor_text_B357
E985: 3E 0F       ld   a,$0F
E987: 06 80       ld   b,$20
E989: CD AE BC    call bitfield_manipulation_B6AE
E98C: A7          and  a
...
E9A1: 3E 04       ld   a,$04
E9A3: C5          push bc
E9A4: CD AE BC    call bitfield_manipulation_B6AE
E9A7: C1          pop  bc
E9A8: 78          ld   a,b
E9A9: FE 0B       cp   $0B
E9AB: C2 B0 E3    jp   nz,$E9B0
table_E9C2:
	dc.b	0x18,0x80,0x28,0x9c,0x18,0x80,0x18,0x80 ; $e9c2
...
%%DCB
table_E92E:
	dc.b	0xa5,0xb5,0x9e,0x04,0x67,0x20,0xb6,0xaf ; $e92e
...
table_EA06:
	...
	dc.b	0xfd,0x02,0x03,0xe7,0x05,0x01,0xe8,0x05 ; $eade
	dc.b	0x01,0xe9,0x05,0x01,0xea,0x05,0x01,0xeb ; $eae6
	dc.b	0x05,0x01,0xec,0x05,0x01,0x02,0x03,0xed ; $eaee
	dc.b	0x05,0x01,0xee,0x05,0x01,0xef,0x05,0x01 ; $eaf6
	dc.b	0xf0,0x05,0x01,0xf1,0x05,0x01,0xf2,0x05 ; $eafe
	dc.b	0x01,0x02,0x03,0xf3,0x05,0x01,0xf4,0x05 ; $eb06
	dc.b	0x01,0xf5,0x05,0x01,0xf6,0x05,0x01,0xf7 ; $eb0e
	dc.b	0x05,0x01,0xf8,0x05,0x01,0x03,0x03,0xf9 ; $eb16
	dc.b	0x05,0x01,0xfa,0x05,0x01,0x00,0x00,0x01 ; $eb1e
	dc.b	0xfb,0x05,0x01,0xfc,0x05,0x01,0xff,0x05 ; $eb26
	dc.b	0x01,0xfd,0x05,0x01,0xfe,0x05,0x01,0x00 ; $eb2e
	dc.b	0x00,0x01,0x02,0x03,0xdb,0x05,0x01,0xdc ; $eb36
	dc.b	0x05,0x01,0xdd,0x05,0x01,0xde,0x05,0x01 ; $eb3e
	dc.b	0xdf,0x05,0x01,0xe0,0x05,0x01,0x02,0x03 ; $eb46
	dc.b	0xe1,0x05,0x01,0xe2,0x05,0x01,0xe3,0x05 ; $eb4e
	dc.b	0x01,0xe4,0x05,0x01,0xe5,0x05,0x01,0xe6 ; $eb56
	dc.b	0x05,0x01,0x01,0x01,0xd8,0x05,0x0d,0x01 ; $eb5e
	dc.b	0x01,0xd9,0x05,0x0d,0x01,0x01,0xda,0x05 ; $eb66
	dc.b	0x0d,0x02,0x03,0xe8,0x05,0x82,0xe7,0x05 ; $eb6e
	dc.b	0x82,0xea,0x05,0x82,0xe9,0x05,0x82,0xec ; $eb76
	dc.b	0x05,0x82,0xeb,0x05,0x82,0x02,0x03,0xee ; $eb7e
	dc.b	0x05,0x82,0xed,0x05,0x82,0xf0,0x05,0x82 ; $eb86
	dc.b	0xef,0x05,0x82,0xf2,0x05,0x82,0xf1,0x05 ; $eb8e
	dc.b	0x82,0x02,0x03,0xf4,0x05,0x82,0xf3,0x05 ; $eb96
	dc.b	0x82,0xf6,0x05,0x82,0xf5,0x05,0x82,0xf8 ; $eb9e
	dc.b	0x05,0x82,0xf7,0x05,0x82,0x03,0x03,0x00 ; $eba6
	dc.b	0x00,0x82,0xfa,0x05,0x82,0xf9,0x05,0x82 ; $ebae
	dc.b	0xff,0x05,0x82,0xfc,0x05,0x82,0xfb,0x05 ; $ebb6
	dc.b	0x82,0x00,0x00,0x82,0xfe,0x05,0x82,0xfd ; $ebbe
	dc.b	0x05,0x82,0x02,0x03,0xdc,0x05,0x82,0xdb ; $ebc6
	dc.b	0x05,0x82,0xde,0x05,0x82,0xdd,0x05,0x82 ; $ebce
	dc.b	0xe0,0x05,0x82,0xdf,0x05,0x82,0x02,0x03 ; $ebd6
	dc.b	0xe2,0x05,0x82,0xe1,0x05,0x82,0xe4,0x05 ; $ebde
	dc.b	0x82,0xe3,0x05,0x82,0xe6,0x05,0x82,0xe5 ; $ebe6
	dc.b	0x05,0x82,0x01,0x01,0xd8,0x05,0x0d,0x01 ; $ebee
	dc.b	0x01,0xd9,0x05,0x8d,0x01,0x01,0xda,0x05 ; $ebf6
	dc.b	0x0d ; $ebfe
...
ED0C: 3E 01       ld   a,$01
ED0E: CD 5E BC    call wait_a_few_frames_B65E
ED11: 06 06       ld   b,$0C
ED13: DD E1       pop  ix
...
ED63: 3E 40       ld   a,$40
ED65: CD 5E BC    call wait_a_few_frames_B65E
ED68: 21 05 0A    ld   hl,$0A05		; immediate
ED6B: 3E 05       ld   a,$05
ED6D: CD E4 F3    call $F9E4
ED70: 3E 40       ld   a,$40
ED72: CD 5E BC    call wait_a_few_frames_B65E
ED75: C1          pop  bc
ED76: 10 E8       djnz $ED5A
ED78: 3E 01       ld   a,$01
ED7A: 06 01       ld   b,$01
ED7C: CD AE BC    call bitfield_manipulation_B6AE
...
table_EDD1:
	dc.b	0x04,0x01,0x17,0x70,0x0a,0x70,0x16,0x70 ; $edd1
...
table_EF7D:
	dc.b	0x08,0x0d,0x19,0x98,0x18,0x98,0x12,0x98 ; $ef7d
...
table_F131:
	dc.b	0x0a,0xb0,0x0b,0xb0,0x0c,0xb0,0x0d,0xb0 ; $f131
...
F174: CD 5E BC    call wait_a_few_frames_B65E
F177: CB 27       sla  a
F179: C6 0F       add  a,$0F
F17B: 6F          ld   l,a
F17C: 26 04       ld   h,$04
...
F192: 3E 80       ld   a,$20
F194: CD 5E BC    call wait_a_few_frames_B65E
F197: E1          pop  hl
F198: E5          push hl
F199: 06 0A       ld   b,$0A
...
F1A5: 3E 80       ld   a,$20
F1A7: CD 5E BC    call wait_a_few_frames_B65E
F1AA: E1          pop  hl
...
F323: 3E 01       ld   a,$01
F325: 06 01       ld   b,$01
F327: CD AE BC    call bitfield_manipulation_B6AE
...
F335: 47          ld   b,a
F336: 3E 1C       ld   a,$16
F338: CD AE BC    call bitfield_manipulation_B6AE
F33B: DD E1       pop  ix
F33D: FD E1       pop  iy
F33F: C1          pop  bc
F340: 05          dec  b
...
F636: 3E 01       ld   a,$01
F638: CD 5E BC    call wait_a_few_frames_B65E
...
F6D6: 3E 90       ld   a,$30
F6D8: CD 5E BC    call wait_a_few_frames_B65E
F6DB: 3E 01       ld   a,$01
F6DD: 06 01       ld   b,$01
F6DF: CD AE BC    call bitfield_manipulation_B6AE
...
F6F0: C9          ret
table_F6F1:
	dc.b	0x02,0x00,0x00,0x00,0x00,0x00,0x13,0xb0 ; $f6f1
...
FA27: C9          ret
table_FA28:
	dc.b	0xb2,0xfa,0xc6,0xfa,0x0a,0xfb,0xec,0xfb ; $fa28
...
FCDF: C9          ret
table_FCE0:
	dc.b	0xe2,0xfc,0x04,0x0c,0xa5,0x04,0xa6,0x04 ; $fce0
...
FDA2: C9          ret
table_FDA3:
	dc.b	0x01,0x1c,0x1d,0x02,0x17,0x0d,0x03,0x1b ; $fda3
...
FDDD: CD 31 B9    call display_multicolor_text_B357
FDE0: C9          ret
table_FDE1:
	dc.b	0x06,0x05,0x9e,0x92,0x9f,0x92,0xbb,0x92 ; $fde1
...
table_FE14:
	dc.b	0x02,0x05,0x7a,0xba,0x7b,0xba,0x7c,0xba ; $fe14
	...
	dc.b	0xff ; $fe44
table_FE45:
	dc.b	0x06,0x05,0x7a,0xba,0x7b,0xba,0x7c,0xba ; $fe45
	...
	dc.b	0xff ; $fe75
table_FE76:
	dc.b	0x07,0x1d,0x30,0x3c,0x0c,0x18,0x19,0x22 ; $fe76
